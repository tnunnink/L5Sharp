...
public class Parameter : LogixElement
{
    ...
    /// </summary>
    /// <value>
    /// A <see cref="Enums.Radix"/> representing the value type format of the <c>Parameter</c>.
    ...
    /// </summary>
    /// <value>
    /// A <see cref="Enums.ExternalAccess"/> representing read/write access of the <c>Parameter</c>.
    ...
    /// </summary>
    /// <value>
    /// A <see cref="Enums.TagType"/> option representing the type of <c>Parameter</c>.
