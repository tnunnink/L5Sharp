...
public class Sheet : Diagram
{
    ...
    /// </summary>
    /// <param name="block">The <see cref="Elements.Block"/> element to add.</param>
    ...
    /// <returns>A <see cref="Elements.Block"/> with the specified id if found; Otherwise null</returns>
    /// <remarks>
    /// 
    /// </remarks>
    ...
    /// <summary>
    /// Retrieves all <see cref="Elements.Block"/> elements found in the sheet diagram.
    /// </summary>
    /// <returns>A collection of <see cref="Elements.Block"/> elements found in the diagram.</returns>
    /// <remarks>
    /// </remarks>
