...
public sealed class LINT : AtomicType, IComparable, IConvertible, ILogixParsable<LINT>
{
    ...
    private new long Value
    {
        get
        {
            ...
            return value is long typed ? typed : (long)Convert.ChangeType(value, typeof(long));
        }
    }
    ...
    /// </summary>
    public LINT() : base(CreateElement(nameof(LINT), Radix.Decimal, 0))
    {
    }
    ...
    public LINT(long value) : base(CreateElement(nameof(LINT), Radix.Decimal, value))
    {
    }
    ...
    public LINT(Radix radix) : base(CreateElement(nameof(LINT), radix, 0))
    {
    }
    ...
    /// <exception cref="ArgumentNullException"><c>radix</c> is null.</exception>
    /// <exception cref="ArgumentException"><c>radix</c> is not supported by the atomic type.</exception>
    public LINT(long value, Radix radix) : base(CreateElement(nameof(LINT), radix, value))
    {
    }
    ...
    public int CompareTo(object? obj)
    {
        return obj switch
        {
            ...
            AtomicType atomic => Value.CompareTo((long)Convert.ChangeType(atomic, typeof(long))),
    ...
    public override bool Equals(object? obj)
    {
        return obj switch
        {
            ...
            AtomicType atomic => Value.Equals((long)Convert.ChangeType(atomic, typeof(long))),
