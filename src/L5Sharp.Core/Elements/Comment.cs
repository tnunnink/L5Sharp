...
/// </remarks>
public class Comment : LogixElement
{
    /// <summary>
    /// Creates a new default <see cref="Comment"/> element.
    /// </summary>
    public Comment() : base(L5XName.Comment)
    {
    }
    ...
    /// </summary>
    public Comment(TagName operand, string value) : this()
    {
        Operand = operand;
        Value = value;
    }
