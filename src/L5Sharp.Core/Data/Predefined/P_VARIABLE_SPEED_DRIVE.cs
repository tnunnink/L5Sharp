...
public sealed partial class P_VARIABLE_SPEED_DRIVE : StructureData
{
    ...
    /// </remarks>
    public override int GetSize() => 652;
    ...
    public override int UpdateData(byte[] data, int offset)
    {
        ...
        Inp_SpeedFdbkData.UpdateData(data, offset + 9);
        Inp_DatalinkData.UpdateData(data, offset + 13);
        Inp_LastFaultCodeData.UpdateData(data, offset + 17);
        Inp_ReadyData.UpdateData((data[offset + 21] & (1 << 3)) != 0);
        Inp_RunningData.UpdateData((data[offset + 21] & (1 << 4)) != 0);
        Inp_CommandDirData.UpdateData((data[offset + 21] & (1 << 5)) != 0);
        Inp_ActualDirData.UpdateData((data[offset + 21] & (1 << 6)) != 0);
        Inp_AcceleratingData.UpdateData((data[offset + 21] & (1 << 7)) != 0);
        Inp_DeceleratingData.UpdateData((data[offset + 22] & (1 << 0)) != 0);
        Inp_AtSpeedData.UpdateData((data[offset + 22] & (1 << 1)) != 0);
        Inp_AlarmData.UpdateData((data[offset + 22] & (1 << 2)) != 0);
        Inp_FaultedData.UpdateData((data[offset + 22] & (1 << 3)) != 0);
        Inp_DvcNotify.UpdateData(data, offset + 22);
        Inp_IOFault.UpdateData((data[offset + 23] & (1 << 4)) != 0);
        Inp_FwdPermOK.UpdateData((data[offset + 23] & (1 << 5)) != 0);
        Inp_FwdNBPermOK.UpdateData((data[offset + 23] & (1 << 6)) != 0);
        Inp_RevPermOK.UpdateData((data[offset + 23] & (1 << 7)) != 0);
        Inp_RevNBPermOK.UpdateData((data[offset + 24] & (1 << 0)) != 0);
        Inp_IntlkOK.UpdateData((data[offset + 24] & (1 << 1)) != 0);
        Inp_NBIntlkOK.UpdateData((data[offset + 24] & (1 << 2)) != 0);
        Inp_IntlkAvailable.UpdateData((data[offset + 24] & (1 << 3)) != 0);
        Inp_IntlkTripInh.UpdateData((data[offset + 24] & (1 << 4)) != 0);
        Inp_RdyReset.UpdateData((data[offset + 24] & (1 << 5)) != 0);
        Inp_Hand.UpdateData((data[offset + 24] & (1 << 6)) != 0);
        Inp_Ovrd.UpdateData((data[offset + 24] & (1 << 7)) != 0);
        Inp_OvrdCmd.UpdateData(data, offset + 24);
        Inp_OvrdSpeed.UpdateData(data, offset + 25);
        Inp_OvrdOutDatalink.UpdateData(data, offset + 29);
        Inp_ExtInh.UpdateData((data[offset + 34] & (1 << 0)) != 0);
        Inp_HornInh.UpdateData((data[offset + 34] & (1 << 1)) != 0);
        Inp_Reset.UpdateData((data[offset + 34] & (1 << 2)) != 0);
        Cfg_AllowDisable.UpdateData((data[offset + 34] & (1 << 3)) != 0);
        Cfg_AllowShelve.UpdateData((data[offset + 34] & (1 << 4)) != 0);
        Cfg_HasReverse.UpdateData((data[offset + 34] & (1 << 5)) != 0);
        Cfg_HasJog.UpdateData((data[offset + 34] & (1 << 6)) != 0);
        Cfg_AllowLocal.UpdateData((data[offset + 34] & (1 << 7)) != 0);
        Cfg_HasRunFdbk.UpdateData((data[offset + 35] & (1 << 0)) != 0);
        Cfg_UseRunFdbk.UpdateData((data[offset + 35] & (1 << 1)) != 0);
        Cfg_HasSpeedFdbk.UpdateData((data[offset + 35] & (1 << 2)) != 0);
        Cfg_UseSpeedFdbk.UpdateData((data[offset + 39] & (1 << 3)) != 0);
        Cfg_HasInpDatalink.UpdateData((data[offset + 39] & (1 << 4)) != 0);
        Cfg_HasOutDatalink.UpdateData((data[offset + 39] & (1 << 5)) != 0);
        Cfg_HasDvcObj.UpdateData((data[offset + 39] & (1 << 6)) != 0);
        Cfg_HasFwdPermObj.UpdateData((data[offset + 39] & (1 << 7)) != 0);
        Cfg_HasRevPermObj.UpdateData((data[offset + 40] & (1 << 0)) != 0);
        Cfg_HasIntlkObj.UpdateData((data[offset + 40] & (1 << 1)) != 0);
        Cfg_HasResInhObj.UpdateData((data[offset + 40] & (1 << 2)) != 0);
        Cfg_HasRunTimeObj.UpdateData((data[offset + 40] & (1 << 3)) != 0);
        Cfg_HasMoreObj.UpdateData((data[offset + 40] & (1 << 4)) != 0);
        Cfg_SetTrack.UpdateData((data[offset + 40] & (1 << 5)) != 0);
        Cfg_SetTrackOvrdHand.UpdateData((data[offset + 40] & (1 << 6)) != 0);
        Cfg_OperStopPrio.UpdateData((data[offset + 40] & (1 << 7)) != 0);
        Cfg_ExtStopPrio.UpdateData((data[offset + 41] & (1 << 0)) != 0);
        Cfg_OCmdResets.UpdateData((data[offset + 41] & (1 << 1)) != 0);
        Cfg_XCmdResets.UpdateData((data[offset + 41] & (1 << 2)) != 0);
        Cfg_OvrdPermIntlk.UpdateData((data[offset + 41] & (1 << 3)) != 0);
        Cfg_ShedOnFailToStart.UpdateData((data[offset + 41] & (1 << 4)) != 0);
        Cfg_ShedOnIOFault.UpdateData((data[offset + 41] & (1 << 5)) != 0);
        Cfg_HasOper.UpdateData((data[offset + 41] & (1 << 6)) != 0);
        Cfg_HasOperLocked.UpdateData((data[offset + 41] & (1 << 7)) != 0);
        Cfg_HasProg.UpdateData((data[offset + 42] & (1 << 0)) != 0);
        Cfg_HasProgLocked.UpdateData((data[offset + 42] & (1 << 1)) != 0);
        Cfg_HasExt.UpdateData((data[offset + 42] & (1 << 2)) != 0);
        Cfg_HasMaint.UpdateData((data[offset + 42] & (1 << 3)) != 0);
        Cfg_HasMaintOoS.UpdateData((data[offset + 42] & (1 << 4)) != 0);
        Cfg_OvrdOverLock.UpdateData((data[offset + 42] & (1 << 5)) != 0);
        Cfg_ExtOverLock.UpdateData((data[offset + 42] & (1 << 6)) != 0);
        Cfg_ProgPwrUp.UpdateData((data[offset + 42] & (1 << 7)) != 0);
        Cfg_ProgNormal.UpdateData((data[offset + 43] & (1 << 0)) != 0);
        Cfg_PCmdPriority.UpdateData((data[offset + 43] & (1 << 1)) != 0);
        Cfg_PCmdProgAsLevel.UpdateData((data[offset + 43] & (1 << 2)) != 0);
        Cfg_PCmdLockAsLevel.UpdateData((data[offset + 43] & (1 << 3)) != 0);
        Cfg_ExtAcqAsLevel.UpdateData((data[offset + 43] & (1 << 4)) != 0);
        Cfg_DecPlcs.UpdateData(data, offset + 43);
        Cfg_InpDatalinkDecPlcs.UpdateData(data, offset + 44);
        Cfg_OutDatalinkDecPlcs.UpdateData(data, offset + 45);
        Cfg_MinSpeedRef.UpdateData(data, offset + 46);
        Cfg_MaxSpeedRef.UpdateData(data, offset + 50);
        Cfg_JogSpeedRef.UpdateData(data, offset + 54);
        Cfg_SpeedRefRawMin.UpdateData(data, offset + 58);
        Cfg_SpeedRefRawMax.UpdateData(data, offset + 62);
        Cfg_SpeedRefEUMin.UpdateData(data, offset + 66);
        Cfg_SpeedRefEUMax.UpdateData(data, offset + 70);
        Cfg_SpeedFdbkRawMin.UpdateData(data, offset + 74);
        Cfg_SpeedFdbkRawMax.UpdateData(data, offset + 78);
        Cfg_SpeedFdbkEUMin.UpdateData(data, offset + 82);
        Cfg_SpeedFdbkEUMax.UpdateData(data, offset + 86);
        Cfg_InpDatalinkRawMin.UpdateData(data, offset + 90);
        Cfg_InpDatalinkRawMax.UpdateData(data, offset + 94);
        Cfg_InpDatalinkEUMin.UpdateData(data, offset + 98);
        Cfg_InpDatalinkEUMax.UpdateData(data, offset + 102);
        Cfg_OutDatalinkMin.UpdateData(data, offset + 106);
        Cfg_OutDatalinkMax.UpdateData(data, offset + 110);
        Cfg_OutDatalinkRawMin.UpdateData(data, offset + 114);
        Cfg_OutDatalinkRawMax.UpdateData(data, offset + 118);
        Cfg_OutDatalinkEUMin.UpdateData(data, offset + 122);
        Cfg_OutDatalinkEUMax.UpdateData(data, offset + 126);
        Cfg_StartHornTime.UpdateData(data, offset + 130);
        Cfg_VirtualRampTime.UpdateData(data, offset + 134);
        Cfg_FailToStartTime.UpdateData(data, offset + 138);
        Cfg_FailToStopTime.UpdateData(data, offset + 142);
        Cfg_ResetPulseTime.UpdateData(data, offset + 146);
        Cfg_MaxJogTime.UpdateData(data, offset + 150);
        Cfg_eKeepRef.UpdateData(data, offset + 154);
        Cfg_eKeepStart.UpdateData(data, offset + 155);
        Cfg_eKeepJog.UpdateData(data, offset + 156);
        Cfg_eKeepOutDatalink.UpdateData(data, offset + 157);
        Cfg_CnfrmReqd.UpdateData(data, offset + 158);
        Cfg_HasHistTrend.UpdateData(data, offset + 159);
        PSet_SpeedRef.UpdateData(data, offset + 160);
        PSet_OutDatalink.UpdateData(data, offset + 164);
        PSet_Owner.UpdateData(data, offset + 168);
        XSet_SpeedRef.UpdateData(data, offset + 172);
        XSet_OutDatalink.UpdateData(data, offset + 176);
        PCmd_Virtual.UpdateData((data[offset + 180] & (1 << 5)) != 0);
        PCmd_Physical.UpdateData((data[offset + 180] & (1 << 6)) != 0);
        PCmd_StartFwd.UpdateData((data[offset + 180] & (1 << 7)) != 0);
        PCmd_StartRev.UpdateData((data[offset + 181] & (1 << 0)) != 0);
        PCmd_Stop.UpdateData((data[offset + 181] & (1 << 1)) != 0);
        PCmd_Prog.UpdateData((data[offset + 181] & (1 << 2)) != 0);
        PCmd_Oper.UpdateData((data[offset + 181] & (1 << 3)) != 0);
        PCmd_Lock.UpdateData((data[offset + 181] & (1 << 4)) != 0);
        PCmd_Unlock.UpdateData((data[offset + 181] & (1 << 5)) != 0);
        PCmd_Normal.UpdateData((data[offset + 181] & (1 << 6)) != 0);
        PCmd_Reset.UpdateData((data[offset + 181] & (1 << 7)) != 0);
        XCmd_StartFwd.UpdateData((data[offset + 182] & (1 << 0)) != 0);
        XCmd_StartRev.UpdateData((data[offset + 182] & (1 << 1)) != 0);
        XCmd_Stop.UpdateData((data[offset + 182] & (1 << 2)) != 0);
        XCmd_JogFwd.UpdateData((data[offset + 182] & (1 << 3)) != 0);
        XCmd_JogRev.UpdateData((data[offset + 182] & (1 << 4)) != 0);
        XCmd_Acq.UpdateData((data[offset + 182] & (1 << 5)) != 0);
        XCmd_Rel.UpdateData((data[offset + 182] & (1 << 6)) != 0);
        XCmd_Reset.UpdateData((data[offset + 182] & (1 << 7)) != 0);
        XCmd_ResetAckAll.UpdateData((data[offset + 183] & (1 << 0)) != 0);
        Out_SpeedRefData.UpdateData(data, offset + 183);
        Out_DatalinkData.UpdateData(data, offset + 187);
        Out_RunData.UpdateData((data[offset + 195] & (1 << 1)) != 0);
        Out_StopData.UpdateData((data[offset + 195] & (1 << 2)) != 0);
        Out_StartData.UpdateData((data[offset + 195] & (1 << 3)) != 0);
        Out_ClearFaultData.UpdateData((data[offset + 195] & (1 << 4)) != 0);
        Out_FwdData.UpdateData((data[offset + 195] & (1 << 5)) != 0);
        Out_RevData.UpdateData((data[offset + 195] & (1 << 6)) != 0);
        Out_HornData.UpdateData((data[offset + 195] & (1 << 7)) != 0);
        Out_Reset.UpdateData((data[offset + 196] & (1 << 0)) != 0);
        Out_OwnerSts.UpdateData(data, offset + 196);
        Val_SpeedRef.UpdateData(data, offset + 200);
        Val_SpeedFdbk.UpdateData(data, offset + 204);
        Val_InpDatalink.UpdateData(data, offset + 208);
        Val_OutDatalink.UpdateData(data, offset + 212);
        Val_SpeedRefEUMin.UpdateData(data, offset + 216);
        Val_SpeedRefEUMax.UpdateData(data, offset + 220);
        Val_SpeedFdbkEUMin.UpdateData(data, offset + 224);
        Val_SpeedFdbkEUMax.UpdateData(data, offset + 228);
        Sts_Initialized.UpdateData((data[offset + 232] & (1 << 1)) != 0);
        Sts_Stopped.UpdateData((data[offset + 232] & (1 << 2)) != 0);
        Sts_StartingFwd.UpdateData((data[offset + 232] & (1 << 3)) != 0);
        Sts_StartingRev.UpdateData((data[offset + 232] & (1 << 4)) != 0);
        Sts_RunningFwd.UpdateData((data[offset + 232] & (1 << 5)) != 0);
        Sts_RunningRev.UpdateData((data[offset + 232] & (1 << 6)) != 0);
        Sts_StoppingFwd.UpdateData((data[offset + 232] & (1 << 7)) != 0);
        Sts_StoppingRev.UpdateData((data[offset + 233] & (1 << 0)) != 0);
        Sts_JoggingFwd.UpdateData((data[offset + 233] & (1 << 1)) != 0);
        Sts_JoggingRev.UpdateData((data[offset + 233] & (1 << 2)) != 0);
        Sts_Horn.UpdateData((data[offset + 233] & (1 << 3)) != 0);
        Sts_CommandDir.UpdateData((data[offset + 233] & (1 << 4)) != 0);
        Sts_ActualDir.UpdateData((data[offset + 233] & (1 << 5)) != 0);
        Sts_Accel.UpdateData((data[offset + 233] & (1 << 6)) != 0);
        Sts_Decel.UpdateData((data[offset + 233] & (1 << 7)) != 0);
        Sts_NotReady.UpdateData((data[offset + 234] & (1 << 0)) != 0);
        Sts_Alarm.UpdateData((data[offset + 234] & (1 << 1)) != 0);
        Sts_AtSpeed.UpdateData((data[offset + 234] & (1 << 2)) != 0);
        Sts_SpeedLimited.UpdateData((data[offset + 234] & (1 << 3)) != 0);
        Sts_Virtual.UpdateData((data[offset + 234] & (1 << 4)) != 0);
        SrcQ_IO.UpdateData(data, offset + 234);
        SrcQ.UpdateData(data, offset + 235);
        Sts_eCmd.UpdateData(data, offset + 236);
        Sts_eFdbk.UpdateData(data, offset + 237);
        Sts_eSts.UpdateData(data, offset + 238);
        Sts_eFault.UpdateData(data, offset + 239);
        Sts_eNotify.UpdateData(data, offset + 240);
        Sts_eNotifyAll.UpdateData(data, offset + 241);
        Sts_eNotifyIOFault.UpdateData(data, offset + 242);
        Sts_eNotifyFailToStart.UpdateData(data, offset + 243);
        Sts_eNotifyFailToStop.UpdateData(data, offset + 244);
        Sts_eNotifyIntlkTrip.UpdateData(data, offset + 245);
        Sts_eNotifyDriveFault.UpdateData(data, offset + 246);
        Sts_UnackAlmCount.UpdateData(data, offset + 247);
        Sts_eFaultCode.UpdateData(data, offset + 251);
        Sts_eSrc.UpdateData(data, offset + 255);
        Sts_bSrc.UpdateData(data, offset + 257);
        Sts_Available.UpdateData((data[offset + 259] & (1 << 5)) != 0);
        Sts_IntlkAvailable.UpdateData((data[offset + 259] & (1 << 6)) != 0);
        Sts_Bypass.UpdateData((data[offset + 259] & (1 << 7)) != 0);
        Sts_BypActive.UpdateData((data[offset + 260] & (1 << 0)) != 0);
        Sts_MaintByp.UpdateData((data[offset + 264] & (1 << 1)) != 0);
        Sts_NotRdy.UpdateData((data[offset + 264] & (1 << 2)) != 0);
        Sts_NrdyCfgErr.UpdateData((data[offset + 264] & (1 << 3)) != 0);
        Sts_NrdyDriveNotReady.UpdateData((data[offset + 264] & (1 << 4)) != 0);
        Sts_NrdyFail.UpdateData((data[offset + 264] & (1 << 5)) != 0);
        Sts_NrdyIntlk.UpdateData((data[offset + 264] & (1 << 6)) != 0);
        Sts_NrdyIOFault.UpdateData((data[offset + 264] & (1 << 7)) != 0);
        Sts_NrdyOoS.UpdateData((data[offset + 265] & (1 << 0)) != 0);
        Sts_NrdyFwdPerm.UpdateData((data[offset + 265] & (1 << 1)) != 0);
        Sts_NrdyRevPerm.UpdateData((data[offset + 265] & (1 << 2)) != 0);
        Sts_NrdyPerm.UpdateData((data[offset + 265] & (1 << 3)) != 0);
        Sts_NrdyPrioStop.UpdateData((data[offset + 265] & (1 << 4)) != 0);
        Sts_NrdyTrip.UpdateData((data[offset + 265] & (1 << 5)) != 0);
        Sts_Err.UpdateData((data[offset + 265] & (1 << 6)) != 0);
        Sts_ErrAlm.UpdateData((data[offset + 265] & (1 << 7)) != 0);
        Sts_ErrSpeedFdbkRaw.UpdateData((data[offset + 266] & (1 << 0)) != 0);
        Sts_ErrSpeedFdbkEU.UpdateData((data[offset + 266] & (1 << 1)) != 0);
        Sts_ErrSpeedRefLim.UpdateData((data[offset + 266] & (1 << 2)) != 0);
        Sts_ErrSpeedRefEU.UpdateData((data[offset + 266] & (1 << 3)) != 0);
        Sts_ErrSpeedRefRaw.UpdateData((data[offset + 266] & (1 << 4)) != 0);
        Sts_ErrInpDatalinkRaw.UpdateData((data[offset + 266] & (1 << 5)) != 0);
        Sts_ErrInpDatalinkEU.UpdateData((data[offset + 266] & (1 << 6)) != 0);
        Sts_ErrOutDatalinkLim.UpdateData((data[offset + 266] & (1 << 7)) != 0);
        Sts_ErrOutDatalinkEU.UpdateData((data[offset + 267] & (1 << 0)) != 0);
        Sts_ErrOutDatalinkRaw.UpdateData((data[offset + 267] & (1 << 1)) != 0);
        Sts_ErrVirtualRampTime.UpdateData((data[offset + 267] & (1 << 2)) != 0);
        Sts_ErrFailToStartTime.UpdateData((data[offset + 267] & (1 << 3)) != 0);
        Sts_ErrFailToStopTime.UpdateData((data[offset + 267] & (1 << 4)) != 0);
        Sts_ErrResetPulseTime.UpdateData((data[offset + 267] & (1 << 5)) != 0);
        Sts_ErrMaxJogTime.UpdateData((data[offset + 267] & (1 << 6)) != 0);
        Sts_Hand.UpdateData((data[offset + 267] & (1 << 7)) != 0);
        Sts_OoS.UpdateData((data[offset + 268] & (1 << 0)) != 0);
        Sts_Maint.UpdateData((data[offset + 268] & (1 << 1)) != 0);
        Sts_Ovrd.UpdateData((data[offset + 268] & (1 << 2)) != 0);
        Sts_Ext.UpdateData((data[offset + 268] & (1 << 3)) != 0);
        Sts_Prog.UpdateData((data[offset + 268] & (1 << 4)) != 0);
        Sts_ProgLocked.UpdateData((data[offset + 268] & (1 << 5)) != 0);
        Sts_Oper.UpdateData((data[offset + 268] & (1 << 6)) != 0);
        Sts_OperLocked.UpdateData((data[offset + 268] & (1 << 7)) != 0);
        Sts_ProgOperSel.UpdateData((data[offset + 269] & (1 << 0)) != 0);
        Sts_ProgOperLock.UpdateData((data[offset + 269] & (1 << 1)) != 0);
        Sts_Normal.UpdateData((data[offset + 269] & (1 << 2)) != 0);
        Sts_ExtReqInh.UpdateData((data[offset + 269] & (1 << 3)) != 0);
        Sts_ProgReqInh.UpdateData((data[offset + 269] & (1 << 4)) != 0);
        Sts_MAcqRcvd.UpdateData((data[offset + 269] & (1 << 5)) != 0);
        Sts_CmdConflict.UpdateData((data[offset + 269] & (1 << 6)) != 0);
        Sts_Alm.UpdateData((data[offset + 269] & (1 << 7)) != 0);
        Sts_AlmInh.UpdateData((data[offset + 274] & (1 << 0)) != 0);
        Sts_IOFault.UpdateData((data[offset + 274] & (1 << 1)) != 0);
        Sts_FailToStart.UpdateData((data[offset + 274] & (1 << 2)) != 0);
        Sts_FailToStop.UpdateData((data[offset + 274] & (1 << 3)) != 0);
        Sts_IntlkTrip.UpdateData((data[offset + 274] & (1 << 4)) != 0);
        Sts_DriveFault.UpdateData((data[offset + 274] & (1 << 5)) != 0);
        Sts_RdyAck.UpdateData((data[offset + 274] & (1 << 6)) != 0);
        Sts_RdyReset.UpdateData((data[offset + 274] & (1 << 7)) != 0);
        XRdy_Acq.UpdateData((data[offset + 275] & (1 << 0)) != 0);
        XRdy_Rel.UpdateData((data[offset + 275] & (1 << 1)) != 0);
        XRdy_StartFwd.UpdateData((data[offset + 275] & (1 << 2)) != 0);
        XRdy_StartRev.UpdateData((data[offset + 275] & (1 << 3)) != 0);
        XRdy_JogFwd.UpdateData((data[offset + 275] & (1 << 4)) != 0);
        XRdy_JogRev.UpdateData((data[offset + 275] & (1 << 5)) != 0);
        XRdy_Stop.UpdateData((data[offset + 275] & (1 << 6)) != 0);
        XRdy_Reset.UpdateData((data[offset + 275] & (1 << 7)) != 0);
        XRdy_ResetAckAll.UpdateData((data[offset + 276] & (1 << 0)) != 0);
        Val_Owner.UpdateData(data, offset + 276);
