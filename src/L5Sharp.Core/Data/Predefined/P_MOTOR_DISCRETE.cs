...
public sealed partial class P_MOTOR_DISCRETE : StructureData
{
    ...
    /// </remarks>
    public override int GetSize() => 512;
    ...
    public override int UpdateData(byte[] data, int offset)
    {
        ...
        Inp_LastFaultCodeData.UpdateData(data, offset + 9);
        Inp_ReadyData.UpdateData((data[offset + 13] & (1 << 3)) != 0);
        Inp_1RunFdbkData.UpdateData((data[offset + 13] & (1 << 4)) != 0);
        Inp_2RunFdbkData.UpdateData((data[offset + 13] & (1 << 5)) != 0);
        Inp_AlarmData.UpdateData((data[offset + 13] & (1 << 6)) != 0);
        Inp_FaultedData.UpdateData((data[offset + 13] & (1 << 7)) != 0);
        Inp_DvcNotify.UpdateData(data, offset + 13);
        Inp_IOFault.UpdateData((data[offset + 15] & (1 << 0)) != 0);
        Inp_1PermOK.UpdateData((data[offset + 15] & (1 << 1)) != 0);
        Inp_1NBPermOK.UpdateData((data[offset + 15] & (1 << 2)) != 0);
        Inp_2PermOK.UpdateData((data[offset + 15] & (1 << 3)) != 0);
        Inp_2NBPermOK.UpdateData((data[offset + 15] & (1 << 4)) != 0);
        Inp_IntlkOK.UpdateData((data[offset + 15] & (1 << 5)) != 0);
        Inp_NBIntlkOK.UpdateData((data[offset + 15] & (1 << 6)) != 0);
        Inp_IntlkAvailable.UpdateData((data[offset + 15] & (1 << 7)) != 0);
        Inp_IntlkTripInh.UpdateData((data[offset + 16] & (1 << 0)) != 0);
        Inp_RdyReset.UpdateData((data[offset + 16] & (1 << 1)) != 0);
        Inp_Hand.UpdateData((data[offset + 16] & (1 << 2)) != 0);
        Inp_Ovrd.UpdateData((data[offset + 16] & (1 << 3)) != 0);
        Inp_OvrdCmd.UpdateData(data, offset + 16);
        Inp_ExtInh.UpdateData((data[offset + 17] & (1 << 4)) != 0);
        Inp_HornInh.UpdateData((data[offset + 17] & (1 << 5)) != 0);
        Inp_Reset.UpdateData((data[offset + 17] & (1 << 6)) != 0);
        Cfg_AllowDisable.UpdateData((data[offset + 17] & (1 << 7)) != 0);
        Cfg_AllowShelve.UpdateData((data[offset + 18] & (1 << 0)) != 0);
        Cfg_eObjType.UpdateData(data, offset + 18);
        Cfg_HasStart1.UpdateData((data[offset + 19] & (1 << 1)) != 0);
        Cfg_HasStart2.UpdateData((data[offset + 19] & (1 << 2)) != 0);
        Cfg_HasJog1.UpdateData((data[offset + 19] & (1 << 3)) != 0);
        Cfg_HasJog2.UpdateData((data[offset + 19] & (1 << 4)) != 0);
        Cfg_HasStop.UpdateData((data[offset + 19] & (1 << 5)) != 0);
        Cfg_AllowLocal.UpdateData((data[offset + 19] & (1 << 6)) != 0);
        Cfg_HasRunFdbk.UpdateData((data[offset + 19] & (1 << 7)) != 0);
        Cfg_UseRunFdbk.UpdateData((data[offset + 20] & (1 << 0)) != 0);
        Cfg_HasDvcObj.UpdateData((data[offset + 20] & (1 << 1)) != 0);
        Cfg_Has1PermObj.UpdateData((data[offset + 20] & (1 << 2)) != 0);
        Cfg_Has2PermObj.UpdateData((data[offset + 24] & (1 << 3)) != 0);
        Cfg_HasIntlkObj.UpdateData((data[offset + 24] & (1 << 4)) != 0);
        Cfg_HasResInhObj.UpdateData((data[offset + 24] & (1 << 5)) != 0);
        Cfg_HasRunTimeObj.UpdateData((data[offset + 24] & (1 << 6)) != 0);
        Cfg_HasMoreObj.UpdateData((data[offset + 24] & (1 << 7)) != 0);
        Cfg_OperStopPrio.UpdateData((data[offset + 25] & (1 << 0)) != 0);
        Cfg_ExtStopPrio.UpdateData((data[offset + 25] & (1 << 1)) != 0);
        Cfg_OCmdResets.UpdateData((data[offset + 25] & (1 << 2)) != 0);
        Cfg_XCmdResets.UpdateData((data[offset + 25] & (1 << 3)) != 0);
        Cfg_OvrdPermIntlk.UpdateData((data[offset + 25] & (1 << 4)) != 0);
        Cfg_ShedOnFailToStart.UpdateData((data[offset + 25] & (1 << 5)) != 0);
        Cfg_ShedOnIOFault.UpdateData((data[offset + 25] & (1 << 6)) != 0);
        Cfg_HasOper.UpdateData((data[offset + 25] & (1 << 7)) != 0);
        Cfg_HasOperLocked.UpdateData((data[offset + 26] & (1 << 0)) != 0);
        Cfg_HasProg.UpdateData((data[offset + 26] & (1 << 1)) != 0);
        Cfg_HasProgLocked.UpdateData((data[offset + 26] & (1 << 2)) != 0);
        Cfg_HasExt.UpdateData((data[offset + 26] & (1 << 3)) != 0);
        Cfg_HasMaint.UpdateData((data[offset + 26] & (1 << 4)) != 0);
        Cfg_HasMaintOoS.UpdateData((data[offset + 26] & (1 << 5)) != 0);
        Cfg_OvrdOverLock.UpdateData((data[offset + 26] & (1 << 6)) != 0);
        Cfg_ExtOverLock.UpdateData((data[offset + 26] & (1 << 7)) != 0);
        Cfg_ProgPwrUp.UpdateData((data[offset + 27] & (1 << 0)) != 0);
        Cfg_ProgNormal.UpdateData((data[offset + 27] & (1 << 1)) != 0);
        Cfg_PCmdPriority.UpdateData((data[offset + 27] & (1 << 2)) != 0);
        Cfg_PCmdProgAsLevel.UpdateData((data[offset + 27] & (1 << 3)) != 0);
        Cfg_PCmdLockAsLevel.UpdateData((data[offset + 27] & (1 << 4)) != 0);
        Cfg_ExtAcqAsLevel.UpdateData((data[offset + 27] & (1 << 5)) != 0);
        Cfg_PauseTime.UpdateData(data, offset + 27);
        Cfg_StartHornTime.UpdateData(data, offset + 31);
        Cfg_VirtualFdbkTime.UpdateData(data, offset + 35);
        Cfg_FailToStartTime.UpdateData(data, offset + 39);
        Cfg_FailToStopTime.UpdateData(data, offset + 43);
        Cfg_ResetPulseTime.UpdateData(data, offset + 47);
        Cfg_MaxJogTime.UpdateData(data, offset + 51);
        Cfg_eKeepStart.UpdateData(data, offset + 55);
        Cfg_eKeepJog.UpdateData(data, offset + 56);
        Cfg_CnfrmReqd.UpdateData(data, offset + 57);
        Cfg_HasHistTrend.UpdateData(data, offset + 58);
        PSet_Owner.UpdateData(data, offset + 59);
        PCmd_Virtual.UpdateData((data[offset + 63] & (1 << 6)) != 0);
        PCmd_Physical.UpdateData((data[offset + 63] & (1 << 7)) != 0);
        PCmd_Start1.UpdateData((data[offset + 64] & (1 << 0)) != 0);
        PCmd_Start2.UpdateData((data[offset + 64] & (1 << 1)) != 0);
        PCmd_Stop.UpdateData((data[offset + 64] & (1 << 2)) != 0);
        PCmd_Prog.UpdateData((data[offset + 64] & (1 << 3)) != 0);
        PCmd_Oper.UpdateData((data[offset + 64] & (1 << 4)) != 0);
        PCmd_Lock.UpdateData((data[offset + 64] & (1 << 5)) != 0);
        PCmd_Unlock.UpdateData((data[offset + 64] & (1 << 6)) != 0);
        PCmd_Normal.UpdateData((data[offset + 64] & (1 << 7)) != 0);
        PCmd_Reset.UpdateData((data[offset + 65] & (1 << 0)) != 0);
        XCmd_Start1.UpdateData((data[offset + 65] & (1 << 1)) != 0);
        XCmd_Start2.UpdateData((data[offset + 65] & (1 << 2)) != 0);
        XCmd_Stop.UpdateData((data[offset + 65] & (1 << 3)) != 0);
        XCmd_Jog1.UpdateData((data[offset + 65] & (1 << 4)) != 0);
        XCmd_Jog2.UpdateData((data[offset + 65] & (1 << 5)) != 0);
        XCmd_Acq.UpdateData((data[offset + 65] & (1 << 6)) != 0);
        XCmd_Rel.UpdateData((data[offset + 65] & (1 << 7)) != 0);
        XCmd_Reset.UpdateData((data[offset + 66] & (1 << 0)) != 0);
        XCmd_ResetAckAll.UpdateData((data[offset + 66] & (1 << 1)) != 0);
        Out_Run1Data.UpdateData((data[offset + 66] & (1 << 2)) != 0);
        Out_Run2Data.UpdateData((data[offset + 66] & (1 << 3)) != 0);
        Out_Start1Data.UpdateData((data[offset + 66] & (1 << 4)) != 0);
        Out_Start2Data.UpdateData((data[offset + 66] & (1 << 5)) != 0);
        Out_StopData.UpdateData((data[offset + 66] & (1 << 6)) != 0);
        Out_ClearFaultData.UpdateData((data[offset + 66] & (1 << 7)) != 0);
        Out_HornData.UpdateData((data[offset + 67] & (1 << 0)) != 0);
        Out_Reset.UpdateData((data[offset + 71] & (1 << 1)) != 0);
        Out_OwnerSts.UpdateData(data, offset + 71);
        Sts_Initialized.UpdateData((data[offset + 75] & (1 << 2)) != 0);
        Sts_Stopped.UpdateData((data[offset + 75] & (1 << 3)) != 0);
        Sts_Starting1.UpdateData((data[offset + 75] & (1 << 4)) != 0);
        Sts_Starting2.UpdateData((data[offset + 75] & (1 << 5)) != 0);
        Sts_Running1.UpdateData((data[offset + 75] & (1 << 6)) != 0);
        Sts_Running2.UpdateData((data[offset + 75] & (1 << 7)) != 0);
        Sts_Stopping.UpdateData((data[offset + 76] & (1 << 0)) != 0);
        Sts_Jogging1.UpdateData((data[offset + 76] & (1 << 1)) != 0);
        Sts_Jogging2.UpdateData((data[offset + 76] & (1 << 2)) != 0);
        Sts_Horn.UpdateData((data[offset + 76] & (1 << 3)) != 0);
        Sts_NotReady.UpdateData((data[offset + 76] & (1 << 4)) != 0);
        Sts_Alarm.UpdateData((data[offset + 76] & (1 << 5)) != 0);
        Sts_Virtual.UpdateData((data[offset + 76] & (1 << 6)) != 0);
        SrcQ_IO.UpdateData(data, offset + 76);
        SrcQ.UpdateData(data, offset + 77);
        Sts_eCmd.UpdateData(data, offset + 78);
        Sts_eFdbk.UpdateData(data, offset + 79);
        Sts_eSts.UpdateData(data, offset + 80);
        Sts_eFault.UpdateData(data, offset + 81);
        Sts_eNotify.UpdateData(data, offset + 82);
        Sts_eNotifyAll.UpdateData(data, offset + 83);
        Sts_eNotifyIOFault.UpdateData(data, offset + 84);
        Sts_eNotifyFailToStart.UpdateData(data, offset + 85);
        Sts_eNotifyFailToStop.UpdateData(data, offset + 86);
        Sts_eNotifyIntlkTrip.UpdateData(data, offset + 87);
        Sts_eNotifyMotorFault.UpdateData(data, offset + 88);
        Sts_UnackAlmCount.UpdateData(data, offset + 89);
        Sts_eFaultCode.UpdateData(data, offset + 93);
        Sts_eSrc.UpdateData(data, offset + 97);
        Sts_bSrc.UpdateData(data, offset + 99);
        Sts_Available.UpdateData((data[offset + 101] & (1 << 7)) != 0);
        Sts_IntlkAvailable.UpdateData((data[offset + 102] & (1 << 0)) != 0);
        Sts_Bypass.UpdateData((data[offset + 102] & (1 << 1)) != 0);
        Sts_BypActive.UpdateData((data[offset + 102] & (1 << 2)) != 0);
        Sts_MaintByp.UpdateData((data[offset + 102] & (1 << 3)) != 0);
        Sts_NotRdy.UpdateData((data[offset + 102] & (1 << 4)) != 0);
        Sts_NrdyCfgErr.UpdateData((data[offset + 102] & (1 << 5)) != 0);
        Sts_NrdyDvcNotReady.UpdateData((data[offset + 102] & (1 << 6)) != 0);
        Sts_NrdyFail.UpdateData((data[offset + 102] & (1 << 7)) != 0);
        Sts_NrdyIntlk.UpdateData((data[offset + 103] & (1 << 0)) != 0);
        Sts_NrdyIOFault.UpdateData((data[offset + 103] & (1 << 1)) != 0);
        Sts_NrdyOoS.UpdateData((data[offset + 103] & (1 << 2)) != 0);
        Sts_Nrdy1Perm.UpdateData((data[offset + 103] & (1 << 3)) != 0);
        Sts_Nrdy2Perm.UpdateData((data[offset + 103] & (1 << 4)) != 0);
        Sts_NrdyPerm.UpdateData((data[offset + 103] & (1 << 5)) != 0);
        Sts_NrdyPrioStop.UpdateData((data[offset + 103] & (1 << 6)) != 0);
        Sts_NrdyTrip.UpdateData((data[offset + 103] & (1 << 7)) != 0);
        Sts_Err.UpdateData((data[offset + 104] & (1 << 0)) != 0);
        Sts_ErrAlm.UpdateData((data[offset + 108] & (1 << 1)) != 0);
        Sts_ErrPauseTime.UpdateData((data[offset + 108] & (1 << 2)) != 0);
        Sts_ErrVirtualFdbkTime.UpdateData((data[offset + 108] & (1 << 3)) != 0);
        Sts_ErrFailToStartTime.UpdateData((data[offset + 108] & (1 << 4)) != 0);
        Sts_ErrFailToStopTime.UpdateData((data[offset + 108] & (1 << 5)) != 0);
        Sts_ErrResetPulseTime.UpdateData((data[offset + 108] & (1 << 6)) != 0);
        Sts_ErrMaxJogTime.UpdateData((data[offset + 108] & (1 << 7)) != 0);
        Sts_Hand.UpdateData((data[offset + 109] & (1 << 0)) != 0);
        Sts_OoS.UpdateData((data[offset + 109] & (1 << 1)) != 0);
        Sts_Maint.UpdateData((data[offset + 109] & (1 << 2)) != 0);
        Sts_Ovrd.UpdateData((data[offset + 109] & (1 << 3)) != 0);
        Sts_Ext.UpdateData((data[offset + 109] & (1 << 4)) != 0);
        Sts_Prog.UpdateData((data[offset + 109] & (1 << 5)) != 0);
        Sts_ProgLocked.UpdateData((data[offset + 109] & (1 << 6)) != 0);
        Sts_Oper.UpdateData((data[offset + 109] & (1 << 7)) != 0);
        Sts_OperLocked.UpdateData((data[offset + 110] & (1 << 0)) != 0);
        Sts_ProgOperSel.UpdateData((data[offset + 110] & (1 << 1)) != 0);
        Sts_ProgOperLock.UpdateData((data[offset + 110] & (1 << 2)) != 0);
        Sts_Normal.UpdateData((data[offset + 110] & (1 << 3)) != 0);
        Sts_ExtReqInh.UpdateData((data[offset + 110] & (1 << 4)) != 0);
        Sts_ProgReqInh.UpdateData((data[offset + 110] & (1 << 5)) != 0);
        Sts_MAcqRcvd.UpdateData((data[offset + 110] & (1 << 6)) != 0);
        Sts_CmdConflict.UpdateData((data[offset + 110] & (1 << 7)) != 0);
        Sts_Alm.UpdateData((data[offset + 111] & (1 << 0)) != 0);
        Sts_AlmInh.UpdateData((data[offset + 111] & (1 << 1)) != 0);
        Sts_IOFault.UpdateData((data[offset + 111] & (1 << 2)) != 0);
        Sts_FailToStart.UpdateData((data[offset + 111] & (1 << 3)) != 0);
        Sts_FailToStop.UpdateData((data[offset + 111] & (1 << 4)) != 0);
        Sts_IntlkTrip.UpdateData((data[offset + 111] & (1 << 5)) != 0);
        Sts_MotorFault.UpdateData((data[offset + 111] & (1 << 6)) != 0);
        Sts_RdyAck.UpdateData((data[offset + 111] & (1 << 7)) != 0);
        Sts_RdyReset.UpdateData((data[offset + 112] & (1 << 0)) != 0);
        XRdy_Acq.UpdateData((data[offset + 112] & (1 << 1)) != 0);
        XRdy_Rel.UpdateData((data[offset + 112] & (1 << 2)) != 0);
        XRdy_Start1.UpdateData((data[offset + 112] & (1 << 3)) != 0);
        XRdy_Start2.UpdateData((data[offset + 112] & (1 << 4)) != 0);
        XRdy_Jog1.UpdateData((data[offset + 112] & (1 << 5)) != 0);
        XRdy_Jog2.UpdateData((data[offset + 112] & (1 << 6)) != 0);
        XRdy_Stop.UpdateData((data[offset + 112] & (1 << 7)) != 0);
        XRdy_Reset.UpdateData((data[offset + 113] & (1 << 0)) != 0);
        XRdy_ResetAckAll.UpdateData((data[offset + 113] & (1 << 1)) != 0);
        Val_Owner.UpdateData(data, offset + 113);
