...
public sealed partial class CC : StructureData
{
    ...
    /// </remarks>
    public override int GetSize() => 8688;
    ...
    public override int UpdateData(byte[] data, int offset)
    {
        ...
        PV.UpdateData(data, offset + 17);
        PVFault.UpdateData((data[offset + 21] & (1 << 1)) != 0);
        PVEUMax.UpdateData(data, offset + 21);
        PVEUMin.UpdateData(data, offset + 25);
        SPProg.UpdateData(data, offset + 29);
        SPOper.UpdateData(data, offset + 33);
        SPHLimit.UpdateData(data, offset + 37);
        SPLLimit.UpdateData(data, offset + 41);
        CV1Fault.UpdateData((data[offset + 45] & (1 << 2)) != 0);
        CV2Fault.UpdateData((data[offset + 45] & (1 << 3)) != 0);
        CV3Fault.UpdateData((data[offset + 45] & (1 << 4)) != 0);
        CV1InitReq.UpdateData((data[offset + 45] & (1 << 5)) != 0);
        CV2InitReq.UpdateData((data[offset + 45] & (1 << 6)) != 0);
        CV3InitReq.UpdateData((data[offset + 45] & (1 << 7)) != 0);
        CV1InitValue.UpdateData(data, offset + 45);
        CV2InitValue.UpdateData(data, offset + 49);
        CV3InitValue.UpdateData(data, offset + 53);
        CV1Prog.UpdateData(data, offset + 57);
        CV2Prog.UpdateData(data, offset + 61);
        CV3Prog.UpdateData(data, offset + 65);
        CV1Oper.UpdateData(data, offset + 69);
        CV2Oper.UpdateData(data, offset + 73);
        CV3Oper.UpdateData(data, offset + 77);
        CV1OverrideValue.UpdateData(data, offset + 81);
        CV2OverrideValue.UpdateData(data, offset + 85);
        CV3OverrideValue.UpdateData(data, offset + 89);
        CV1TrackValue.UpdateData(data, offset + 93);
        CV2TrackValue.UpdateData(data, offset + 97);
        CV3TrackValue.UpdateData(data, offset + 101);
        CVManLimiting.UpdateData((data[offset + 106] & (1 << 0)) != 0);
        CV1EUMax.UpdateData(data, offset + 106);
        CV2EUMax.UpdateData(data, offset + 110);
        CV3EUMax.UpdateData(data, offset + 114);
        CV1EUMin.UpdateData(data, offset + 118);
        CV2EUMin.UpdateData(data, offset + 122);
        CV3EUMin.UpdateData(data, offset + 126);
        CV1HLimit.UpdateData(data, offset + 130);
        CV2HLimit.UpdateData(data, offset + 134);
        CV3HLimit.UpdateData(data, offset + 138);
        CV1LLimit.UpdateData(data, offset + 142);
        CV2LLimit.UpdateData(data, offset + 146);
        CV3LLimit.UpdateData(data, offset + 150);
        CV1ROCPosLimit.UpdateData(data, offset + 154);
        CV2ROCPosLimit.UpdateData(data, offset + 158);
        CV3ROCPosLimit.UpdateData(data, offset + 162);
        CV1ROCNegLimit.UpdateData(data, offset + 166);
        CV2ROCNegLimit.UpdateData(data, offset + 170);
        CV3ROCNegLimit.UpdateData(data, offset + 174);
        CV1HandFB.UpdateData(data, offset + 178);
        CV2HandFB.UpdateData(data, offset + 182);
        CV3HandFB.UpdateData(data, offset + 186);
        CV1HandFBFault.UpdateData((data[offset + 190] & (1 << 1)) != 0);
        CV2HandFBFault.UpdateData((data[offset + 190] & (1 << 2)) != 0);
        CV3HandFBFault.UpdateData((data[offset + 190] & (1 << 3)) != 0);
        CV1Target.UpdateData(data, offset + 190);
        CV2Target.UpdateData(data, offset + 194);
        CV3Target.UpdateData(data, offset + 198);
        CV1WindupHIn.UpdateData((data[offset + 202] & (1 << 4)) != 0);
        CV2WindupHIn.UpdateData((data[offset + 202] & (1 << 5)) != 0);
        CV3WindupHIn.UpdateData((data[offset + 202] & (1 << 6)) != 0);
        CV1WindupLIn.UpdateData((data[offset + 202] & (1 << 7)) != 0);
        CV2WindupLIn.UpdateData((data[offset + 203] & (1 << 0)) != 0);
        CV3WindupLIn.UpdateData((data[offset + 203] & (1 << 1)) != 0);
        GainEUSpan.UpdateData((data[offset + 203] & (1 << 2)) != 0);
        CV1ProcessGainSign.UpdateData((data[offset + 203] & (1 << 3)) != 0);
        CV2ProcessGainSign.UpdateData((data[offset + 203] & (1 << 4)) != 0);
        CV3ProcessGainSign.UpdateData((data[offset + 203] & (1 << 5)) != 0);
        ProcessType.UpdateData(data, offset + 203);
        CV1ModelGain.UpdateData(data, offset + 207);
        CV2ModelGain.UpdateData(data, offset + 211);
        CV3ModelGain.UpdateData(data, offset + 215);
        CV1ModelTC.UpdateData(data, offset + 219);
        CV2ModelTC.UpdateData(data, offset + 223);
        CV3ModelTC.UpdateData(data, offset + 227);
        CV1ModelDT.UpdateData(data, offset + 231);
        CV2ModelDT.UpdateData(data, offset + 235);
        CV3ModelDT.UpdateData(data, offset + 239);
        CV1RespTC.UpdateData(data, offset + 243);
        CV2RespTC.UpdateData(data, offset + 247);
        CV3RespTC.UpdateData(data, offset + 251);
        Act1stCV.UpdateData(data, offset + 255);
        Act2ndCV.UpdateData(data, offset + 259);
        Act3rdCV.UpdateData(data, offset + 263);
        Target1stCV.UpdateData(data, offset + 267);
        Target2ndCV.UpdateData(data, offset + 271);
        Target3rdCV.UpdateData(data, offset + 275);
        TargetRespTC.UpdateData(data, offset + 279);
        PVTracking.UpdateData((data[offset + 283] & (1 << 6)) != 0);
        CVTrackReq.UpdateData((data[offset + 283] & (1 << 7)) != 0);
        ManualAfterInit.UpdateData((data[offset + 284] & (1 << 0)) != 0);
        ProgProgReq.UpdateData((data[offset + 284] & (1 << 1)) != 0);
        ProgOperReq.UpdateData((data[offset + 284] & (1 << 2)) != 0);
        ProgCV1AutoReq.UpdateData((data[offset + 284] & (1 << 3)) != 0);
        ProgCV2AutoReq.UpdateData((data[offset + 284] & (1 << 4)) != 0);
        ProgCV3AutoReq.UpdateData((data[offset + 284] & (1 << 5)) != 0);
        ProgCV1ManualReq.UpdateData((data[offset + 284] & (1 << 6)) != 0);
        ProgCV2ManualReq.UpdateData((data[offset + 284] & (1 << 7)) != 0);
        ProgCV3ManualReq.UpdateData((data[offset + 285] & (1 << 0)) != 0);
        ProgCV1OverrideReq.UpdateData((data[offset + 285] & (1 << 1)) != 0);
        ProgCV2OverrideReq.UpdateData((data[offset + 285] & (1 << 2)) != 0);
        ProgCV3OverrideReq.UpdateData((data[offset + 285] & (1 << 3)) != 0);
        ProgCV1HandReq.UpdateData((data[offset + 285] & (1 << 4)) != 0);
        ProgCV2HandReq.UpdateData((data[offset + 285] & (1 << 5)) != 0);
        ProgCV3HandReq.UpdateData((data[offset + 285] & (1 << 6)) != 0);
        OperProgReq.UpdateData((data[offset + 285] & (1 << 7)) != 0);
        OperOperReq.UpdateData((data[offset + 286] & (1 << 0)) != 0);
        OperCV1AutoReq.UpdateData((data[offset + 286] & (1 << 1)) != 0);
        OperCV2AutoReq.UpdateData((data[offset + 286] & (1 << 2)) != 0);
        OperCV3AutoReq.UpdateData((data[offset + 286] & (1 << 3)) != 0);
        OperCV1ManualReq.UpdateData((data[offset + 286] & (1 << 4)) != 0);
        OperCV2ManualReq.UpdateData((data[offset + 286] & (1 << 5)) != 0);
        OperCV3ManualReq.UpdateData((data[offset + 286] & (1 << 6)) != 0);
        ProgValueReset.UpdateData((data[offset + 286] & (1 << 7)) != 0);
        TimingMode.UpdateData(data, offset + 286);
        OversampleDT.UpdateData(data, offset + 290);
        RTSTime.UpdateData(data, offset + 294);
        RTSTimeStamp.UpdateData(data, offset + 298);
        PVTuneLimit.UpdateData(data, offset + 302);
        AtuneTimeLimit.UpdateData(data, offset + 306);
        NoiseLevel.UpdateData(data, offset + 310);
        CV1StepSize.UpdateData(data, offset + 314);
        CV2StepSize.UpdateData(data, offset + 318);
        CV3StepSize.UpdateData(data, offset + 322);
        CV1ResponseSpeed.UpdateData(data, offset + 326);
        CV2ResponseSpeed.UpdateData(data, offset + 330);
        CV3ResponseSpeed.UpdateData(data, offset + 334);
        CV1ModelInit.UpdateData((data[offset + 339] & (1 << 0)) != 0);
        CV2ModelInit.UpdateData((data[offset + 339] & (1 << 1)) != 0);
        CV3ModelInit.UpdateData((data[offset + 339] & (1 << 2)) != 0);
        Factor.UpdateData(data, offset + 339);
        AtuneCV1Start.UpdateData((data[offset + 347] & (1 << 3)) != 0);
        AtuneCV2Start.UpdateData((data[offset + 347] & (1 << 4)) != 0);
        AtuneCV3Start.UpdateData((data[offset + 347] & (1 << 5)) != 0);
        AtuneCV1UseModel.UpdateData((data[offset + 347] & (1 << 6)) != 0);
        AtuneCV2UseModel.UpdateData((data[offset + 347] & (1 << 7)) != 0);
        AtuneCV3UseModel.UpdateData((data[offset + 348] & (1 << 0)) != 0);
        AtuneCV1Abort.UpdateData((data[offset + 348] & (1 << 1)) != 0);
        AtuneCV2Abort.UpdateData((data[offset + 348] & (1 << 2)) != 0);
        AtuneCV3Abort.UpdateData((data[offset + 348] & (1 << 3)) != 0);
        EnableOut.UpdateData((data[offset + 348] & (1 << 4)) != 0);
        CV1EU.UpdateData(data, offset + 364);
        CV2EU.UpdateData(data, offset + 368);
        CV3EU.UpdateData(data, offset + 372);
        CV1.UpdateData(data, offset + 376);
        CV2.UpdateData(data, offset + 380);
        CV3.UpdateData(data, offset + 384);
        DeltaCV1.UpdateData(data, offset + 388);
        DeltaCV2.UpdateData(data, offset + 392);
        DeltaCV3.UpdateData(data, offset + 396);
        CV1Initializing.UpdateData((data[offset + 400] & (1 << 5)) != 0);
        CV2Initializing.UpdateData((data[offset + 400] & (1 << 6)) != 0);
        CV3Initializing.UpdateData((data[offset + 400] & (1 << 7)) != 0);
        CV1HAlarm.UpdateData((data[offset + 401] & (1 << 0)) != 0);
        CV2HAlarm.UpdateData((data[offset + 401] & (1 << 1)) != 0);
        CV3HAlarm.UpdateData((data[offset + 401] & (1 << 2)) != 0);
        CV1LAlarm.UpdateData((data[offset + 401] & (1 << 3)) != 0);
        CV2LAlarm.UpdateData((data[offset + 401] & (1 << 4)) != 0);
        CV3LAlarm.UpdateData((data[offset + 401] & (1 << 5)) != 0);
        CV1ROCPosAlarm.UpdateData((data[offset + 401] & (1 << 6)) != 0);
        CV2ROCPosAlarm.UpdateData((data[offset + 401] & (1 << 7)) != 0);
        CV3ROCPosAlarm.UpdateData((data[offset + 402] & (1 << 0)) != 0);
        CV1ROCNegAlarm.UpdateData((data[offset + 402] & (1 << 1)) != 0);
        CV2ROCNegAlarm.UpdateData((data[offset + 402] & (1 << 2)) != 0);
        CV3ROCNegAlarm.UpdateData((data[offset + 402] & (1 << 3)) != 0);
        SP.UpdateData(data, offset + 402);
        SPPercent.UpdateData(data, offset + 406);
        SPHAlarm.UpdateData((data[offset + 410] & (1 << 4)) != 0);
        SPLAlarm.UpdateData((data[offset + 410] & (1 << 5)) != 0);
        PVPercent.UpdateData(data, offset + 410);
        E.UpdateData(data, offset + 414);
        EPercent.UpdateData(data, offset + 418);
        CV1WindupHOut.UpdateData((data[offset + 422] & (1 << 6)) != 0);
        CV2WindupHOut.UpdateData((data[offset + 422] & (1 << 7)) != 0);
        CV3WindupHOut.UpdateData((data[offset + 423] & (1 << 0)) != 0);
        CV1WindupLOut.UpdateData((data[offset + 423] & (1 << 1)) != 0);
        CV2WindupLOut.UpdateData((data[offset + 423] & (1 << 2)) != 0);
        CV3WindupLOut.UpdateData((data[offset + 423] & (1 << 3)) != 0);
        ProgOper.UpdateData((data[offset + 423] & (1 << 4)) != 0);
        CV1Auto.UpdateData((data[offset + 423] & (1 << 5)) != 0);
        CV2Auto.UpdateData((data[offset + 423] & (1 << 6)) != 0);
        CV3Auto.UpdateData((data[offset + 423] & (1 << 7)) != 0);
        CV1Manual.UpdateData((data[offset + 424] & (1 << 0)) != 0);
        CV2Manual.UpdateData((data[offset + 424] & (1 << 1)) != 0);
        CV3Manual.UpdateData((data[offset + 424] & (1 << 2)) != 0);
        CV1Override.UpdateData((data[offset + 424] & (1 << 3)) != 0);
        CV2Override.UpdateData((data[offset + 424] & (1 << 4)) != 0);
        CV3Override.UpdateData((data[offset + 424] & (1 << 5)) != 0);
        CV1Hand.UpdateData((data[offset + 424] & (1 << 6)) != 0);
        CV2Hand.UpdateData((data[offset + 424] & (1 << 7)) != 0);
        CV3Hand.UpdateData((data[offset + 425] & (1 << 0)) != 0);
        DeltaT.UpdateData(data, offset + 425);
        CV1StepSizeUsed.UpdateData(data, offset + 429);
        CV2StepSizeUsed.UpdateData(data, offset + 433);
        CV3StepSizeUsed.UpdateData(data, offset + 437);
        CV1GainTuned.UpdateData(data, offset + 441);
        CV2GainTuned.UpdateData(data, offset + 445);
        CV3GainTuned.UpdateData(data, offset + 449);
        CV1TCTuned.UpdateData(data, offset + 453);
        CV2TCTuned.UpdateData(data, offset + 457);
        CV3TCTuned.UpdateData(data, offset + 461);
        CV1DTTuned.UpdateData(data, offset + 465);
        CV2DTTuned.UpdateData(data, offset + 469);
        CV3DTTuned.UpdateData(data, offset + 473);
        CV1RespTCTunedS.UpdateData(data, offset + 477);
        CV2RespTCTunedS.UpdateData(data, offset + 481);
        CV3RespTCTunedS.UpdateData(data, offset + 485);
        CV1RespTCTunedM.UpdateData(data, offset + 489);
        CV2RespTCTunedM.UpdateData(data, offset + 493);
        CV3RespTCTunedM.UpdateData(data, offset + 497);
        CV1RespTCTunedF.UpdateData(data, offset + 501);
        CV2RespTCTunedF.UpdateData(data, offset + 505);
        CV3RespTCTunedF.UpdateData(data, offset + 509);
        AtuneCV1On.UpdateData((data[offset + 517] & (1 << 1)) != 0);
        AtuneCV2On.UpdateData((data[offset + 517] & (1 << 2)) != 0);
        AtuneCV3On.UpdateData((data[offset + 517] & (1 << 3)) != 0);
        AtuneCV1Done.UpdateData((data[offset + 517] & (1 << 4)) != 0);
        AtuneCV2Done.UpdateData((data[offset + 517] & (1 << 5)) != 0);
        AtuneCV3Done.UpdateData((data[offset + 517] & (1 << 6)) != 0);
        AtuneCV1Aborted.UpdateData((data[offset + 517] & (1 << 7)) != 0);
        AtuneCV2Aborted.UpdateData((data[offset + 518] & (1 << 0)) != 0);
        AtuneCV3Aborted.UpdateData((data[offset + 518] & (1 << 1)) != 0);
        AtuneCV1Status.UpdateData(data, offset + 518);
        AtuneCV2Status.UpdateData(data, offset + 522);
        AtuneCV3Status.UpdateData(data, offset + 526);
        AtuneCV1Fault.UpdateData((data[offset + 530] & (1 << 2)) != 0);
        AtuneCV1PVOutOfLimit.UpdateData((data[offset + 530] & (1 << 3)) != 0);
        AtuneCV1ModeInv.UpdateData((data[offset + 530] & (1 << 4)) != 0);
        AtuneCV1WindupFault.UpdateData((data[offset + 530] & (1 << 5)) != 0);
        AtuneCV1StepSize0.UpdateData((data[offset + 530] & (1 << 6)) != 0);
        AtuneCV1LimitsFault.UpdateData((data[offset + 530] & (1 << 7)) != 0);
        AtuneCV1InitFault.UpdateData((data[offset + 531] & (1 << 0)) != 0);
        AtuneCV1EUSpanChanged.UpdateData((data[offset + 531] & (1 << 1)) != 0);
        AtuneCV1Changed.UpdateData((data[offset + 531] & (1 << 2)) != 0);
        AtuneCV1Timeout.UpdateData((data[offset + 531] & (1 << 3)) != 0);
        AtuneCV1PVNotSettled.UpdateData((data[offset + 531] & (1 << 4)) != 0);
        AtuneCV2Fault.UpdateData((data[offset + 531] & (1 << 5)) != 0);
        AtuneCV2PVOutOfLimit.UpdateData((data[offset + 531] & (1 << 6)) != 0);
        AtuneCV2ModeInv.UpdateData((data[offset + 531] & (1 << 7)) != 0);
        AtuneCV2WindupFault.UpdateData((data[offset + 532] & (1 << 0)) != 0);
        AtuneCV2StepSize0.UpdateData((data[offset + 532] & (1 << 1)) != 0);
        AtuneCV2LimitsFault.UpdateData((data[offset + 532] & (1 << 2)) != 0);
        AtuneCV2InitFault.UpdateData((data[offset + 532] & (1 << 3)) != 0);
        AtuneCV2EUSpanChanged.UpdateData((data[offset + 532] & (1 << 4)) != 0);
        AtuneCV2Changed.UpdateData((data[offset + 532] & (1 << 5)) != 0);
        AtuneCV2Timeout.UpdateData((data[offset + 532] & (1 << 6)) != 0);
        AtuneCV2PVNotSettled.UpdateData((data[offset + 532] & (1 << 7)) != 0);
        AtuneCV3Fault.UpdateData((data[offset + 533] & (1 << 0)) != 0);
        AtuneCV3PVOutOfLimit.UpdateData((data[offset + 533] & (1 << 1)) != 0);
        AtuneCV3ModeInv.UpdateData((data[offset + 533] & (1 << 2)) != 0);
        AtuneCV3WindupFault.UpdateData((data[offset + 533] & (1 << 3)) != 0);
        AtuneCV3StepSize0.UpdateData((data[offset + 533] & (1 << 4)) != 0);
        AtuneCV3LimitsFault.UpdateData((data[offset + 533] & (1 << 5)) != 0);
        AtuneCV3InitFault.UpdateData((data[offset + 533] & (1 << 6)) != 0);
        AtuneCV3EUSpanChanged.UpdateData((data[offset + 533] & (1 << 7)) != 0);
        AtuneCV3Changed.UpdateData((data[offset + 534] & (1 << 0)) != 0);
        AtuneCV3Timeout.UpdateData((data[offset + 534] & (1 << 1)) != 0);
        AtuneCV3PVNotSettled.UpdateData((data[offset + 534] & (1 << 2)) != 0);
        Status1.UpdateData(data, offset + 534);
        Status2.UpdateData(data, offset + 538);
        Status3CV1.UpdateData(data, offset + 542);
        Status3CV2.UpdateData(data, offset + 546);
        Status3CV3.UpdateData(data, offset + 550);
        InstructFault.UpdateData((data[offset + 554] & (1 << 3)) != 0);
        PVFaulted.UpdateData((data[offset + 554] & (1 << 4)) != 0);
        PVSpanInv.UpdateData((data[offset + 554] & (1 << 5)) != 0);
        SPProgInv.UpdateData((data[offset + 554] & (1 << 6)) != 0);
        SPOperInv.UpdateData((data[offset + 554] & (1 << 7)) != 0);
        SPLimitsInv.UpdateData((data[offset + 555] & (1 << 0)) != 0);
        SampleTimeTooSmall.UpdateData((data[offset + 555] & (1 << 1)) != 0);
        FactorInv.UpdateData((data[offset + 555] & (1 << 2)) != 0);
        TimingModeInv.UpdateData((data[offset + 555] & (1 << 3)) != 0);
        RTSMissed.UpdateData((data[offset + 555] & (1 << 4)) != 0);
        RTSTimeInv.UpdateData((data[offset + 555] & (1 << 5)) != 0);
        RTSTimeStampInv.UpdateData((data[offset + 555] & (1 << 6)) != 0);
        DeltaTInv.UpdateData((data[offset + 555] & (1 << 7)) != 0);
        CV1Faulted.UpdateData((data[offset + 556] & (1 << 0)) != 0);
        CV1HandFBFaulted.UpdateData((data[offset + 556] & (1 << 1)) != 0);
        CV1ProgInv.UpdateData((data[offset + 556] & (1 << 2)) != 0);
        CV1OperInv.UpdateData((data[offset + 556] & (1 << 3)) != 0);
        CV1OverrideValueInv.UpdateData((data[offset + 556] & (1 << 4)) != 0);
        CV1TrackValueInv.UpdateData((data[offset + 556] & (1 << 5)) != 0);
        CV1EUSpanInv.UpdateData((data[offset + 556] & (1 << 6)) != 0);
        CV1LimitsInv.UpdateData((data[offset + 556] & (1 << 7)) != 0);
        CV1ROCLimitInv.UpdateData((data[offset + 557] & (1 << 0)) != 0);
        CV1HandFBInv.UpdateData((data[offset + 557] & (1 << 1)) != 0);
        CV1ModelGainInv.UpdateData((data[offset + 557] & (1 << 2)) != 0);
        CV1ModelTCInv.UpdateData((data[offset + 557] & (1 << 3)) != 0);
        CV1ModelDTInv.UpdateData((data[offset + 557] & (1 << 4)) != 0);
        CV1RespTCInv.UpdateData((data[offset + 557] & (1 << 5)) != 0);
        CV1TargetInv.UpdateData((data[offset + 557] & (1 << 6)) != 0);
        CV2Faulted.UpdateData((data[offset + 557] & (1 << 7)) != 0);
        CV2HandFBFaulted.UpdateData((data[offset + 558] & (1 << 0)) != 0);
        CV2ProgInv.UpdateData((data[offset + 558] & (1 << 1)) != 0);
        CV2OperInv.UpdateData((data[offset + 558] & (1 << 2)) != 0);
        CV2OverrideValueInv.UpdateData((data[offset + 558] & (1 << 3)) != 0);
        CV2TrackValueInv.UpdateData((data[offset + 558] & (1 << 4)) != 0);
        CV2EUSpanInv.UpdateData((data[offset + 558] & (1 << 5)) != 0);
        CV2LimitsInv.UpdateData((data[offset + 558] & (1 << 6)) != 0);
        CV2ROCLimitInv.UpdateData((data[offset + 558] & (1 << 7)) != 0);
        CV2HandFBInv.UpdateData((data[offset + 559] & (1 << 0)) != 0);
        CV2ModelGainInv.UpdateData((data[offset + 559] & (1 << 1)) != 0);
        CV2ModelTCInv.UpdateData((data[offset + 559] & (1 << 2)) != 0);
        CV2ModelDTInv.UpdateData((data[offset + 559] & (1 << 3)) != 0);
        CV2RespTCInv.UpdateData((data[offset + 559] & (1 << 4)) != 0);
        CV2TargetInv.UpdateData((data[offset + 559] & (1 << 5)) != 0);
        CV3Faulted.UpdateData((data[offset + 559] & (1 << 6)) != 0);
        CV3HandFBFaulted.UpdateData((data[offset + 559] & (1 << 7)) != 0);
        CV3ProgInv.UpdateData((data[offset + 560] & (1 << 0)) != 0);
        CV3OperInv.UpdateData((data[offset + 560] & (1 << 1)) != 0);
        CV3OverrideValueInv.UpdateData((data[offset + 560] & (1 << 2)) != 0);
        CV3TrackValueInv.UpdateData((data[offset + 560] & (1 << 3)) != 0);
        CV3EUSpanInv.UpdateData((data[offset + 560] & (1 << 4)) != 0);
        CV3LimitsInv.UpdateData((data[offset + 560] & (1 << 5)) != 0);
        CV3ROCLimitInv.UpdateData((data[offset + 560] & (1 << 6)) != 0);
        CV3HandFBInv.UpdateData((data[offset + 560] & (1 << 7)) != 0);
        CV3ModelGainInv.UpdateData((data[offset + 561] & (1 << 0)) != 0);
        CV3ModelTCInv.UpdateData((data[offset + 561] & (1 << 1)) != 0);
        CV3ModelDTInv.UpdateData((data[offset + 561] & (1 << 2)) != 0);
        CV3RespTCInv.UpdateData((data[offset + 561] & (1 << 3)) != 0);
        CV3TargetInv.UpdateData((data[offset + 561] & (1 << 4)) != 0);
