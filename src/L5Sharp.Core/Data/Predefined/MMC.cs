...
public sealed partial class MMC : StructureData
{
    ...
    /// </remarks>
    public override int GetSize() => 16384;
    ...
    public override int UpdateData(byte[] data, int offset)
    {
        ...
        PV1.UpdateData(data, offset + 17);
        PV2.UpdateData(data, offset + 21);
        PV1Fault.UpdateData((data[offset + 25] & (1 << 1)) != 0);
        PV2Fault.UpdateData((data[offset + 25] & (1 << 2)) != 0);
        PV1EUMax.UpdateData(data, offset + 25);
        PV2EUMax.UpdateData(data, offset + 29);
        PV1EUMin.UpdateData(data, offset + 33);
        PV2EUMin.UpdateData(data, offset + 37);
        SP1Prog.UpdateData(data, offset + 41);
        SP2Prog.UpdateData(data, offset + 45);
        SP1Oper.UpdateData(data, offset + 49);
        SP2Oper.UpdateData(data, offset + 53);
        SP1HLimit.UpdateData(data, offset + 57);
        SP2HLimit.UpdateData(data, offset + 61);
        SP1LLimit.UpdateData(data, offset + 65);
        SP2LLimit.UpdateData(data, offset + 69);
        CV1Fault.UpdateData((data[offset + 73] & (1 << 3)) != 0);
        CV2Fault.UpdateData((data[offset + 73] & (1 << 4)) != 0);
        CV3Fault.UpdateData((data[offset + 73] & (1 << 5)) != 0);
        CV1InitReq.UpdateData((data[offset + 73] & (1 << 6)) != 0);
        CV2InitReq.UpdateData((data[offset + 73] & (1 << 7)) != 0);
        CV3InitReq.UpdateData((data[offset + 74] & (1 << 0)) != 0);
        CV1InitValue.UpdateData(data, offset + 74);
        CV2InitValue.UpdateData(data, offset + 78);
        CV3InitValue.UpdateData(data, offset + 82);
        CV1Prog.UpdateData(data, offset + 86);
        CV2Prog.UpdateData(data, offset + 90);
        CV3Prog.UpdateData(data, offset + 94);
        CV1Oper.UpdateData(data, offset + 98);
        CV2Oper.UpdateData(data, offset + 102);
        CV3Oper.UpdateData(data, offset + 106);
        CV1OverrideValue.UpdateData(data, offset + 110);
        CV2OverrideValue.UpdateData(data, offset + 114);
        CV3OverrideValue.UpdateData(data, offset + 118);
        CVManLimiting.UpdateData((data[offset + 122] & (1 << 1)) != 0);
        CV1EUMax.UpdateData(data, offset + 122);
        CV2EUMax.UpdateData(data, offset + 126);
        CV3EUMax.UpdateData(data, offset + 130);
        CV1EUMin.UpdateData(data, offset + 134);
        CV2EUMin.UpdateData(data, offset + 138);
        CV3EUMin.UpdateData(data, offset + 142);
        CV1HLimit.UpdateData(data, offset + 146);
        CV2HLimit.UpdateData(data, offset + 150);
        CV3HLimit.UpdateData(data, offset + 154);
        CV1LLimit.UpdateData(data, offset + 158);
        CV2LLimit.UpdateData(data, offset + 162);
        CV3LLimit.UpdateData(data, offset + 166);
        CV1ROCPosLimit.UpdateData(data, offset + 170);
        CV2ROCPosLimit.UpdateData(data, offset + 174);
        CV3ROCPosLimit.UpdateData(data, offset + 178);
        CV1ROCNegLimit.UpdateData(data, offset + 182);
        CV2ROCNegLimit.UpdateData(data, offset + 186);
        CV3ROCNegLimit.UpdateData(data, offset + 190);
        CV1HandFB.UpdateData(data, offset + 194);
        CV2HandFB.UpdateData(data, offset + 198);
        CV3HandFB.UpdateData(data, offset + 202);
        CV1HandFBFault.UpdateData((data[offset + 206] & (1 << 2)) != 0);
        CV2HandFBFault.UpdateData((data[offset + 206] & (1 << 3)) != 0);
        CV3HandFBFault.UpdateData((data[offset + 206] & (1 << 4)) != 0);
        CV1Target.UpdateData(data, offset + 206);
        CV2Target.UpdateData(data, offset + 210);
        CV3Target.UpdateData(data, offset + 214);
        CV1WindupHIn.UpdateData((data[offset + 218] & (1 << 5)) != 0);
        CV2WindupHIn.UpdateData((data[offset + 218] & (1 << 6)) != 0);
        CV3WindupHIn.UpdateData((data[offset + 218] & (1 << 7)) != 0);
        CV1WindupLIn.UpdateData((data[offset + 219] & (1 << 0)) != 0);
        CV2WindupLIn.UpdateData((data[offset + 219] & (1 << 1)) != 0);
        CV3WindupLIn.UpdateData((data[offset + 219] & (1 << 2)) != 0);
        GainEUSpan.UpdateData((data[offset + 219] & (1 << 3)) != 0);
        CV1PV1ProcessGainSign.UpdateData((data[offset + 219] & (1 << 4)) != 0);
        CV2PV1ProcessGainSign.UpdateData((data[offset + 219] & (1 << 5)) != 0);
        CV3PV1ProcessGainSign.UpdateData((data[offset + 219] & (1 << 6)) != 0);
        CV1PV2ProcessGainSign.UpdateData((data[offset + 219] & (1 << 7)) != 0);
        CV2PV2ProcessGainSign.UpdateData((data[offset + 220] & (1 << 0)) != 0);
        CV3PV2ProcessGainSign.UpdateData((data[offset + 220] & (1 << 1)) != 0);
        ProcessType.UpdateData(data, offset + 220);
        CV1PV1ModelGain.UpdateData(data, offset + 224);
        CV2PV1ModelGain.UpdateData(data, offset + 228);
        CV3PV1ModelGain.UpdateData(data, offset + 232);
        CV1PV2ModelGain.UpdateData(data, offset + 236);
        CV2PV2ModelGain.UpdateData(data, offset + 240);
        CV3PV2ModelGain.UpdateData(data, offset + 244);
        CV1PV1ModelTC.UpdateData(data, offset + 248);
        CV2PV1ModelTC.UpdateData(data, offset + 252);
        CV3PV1ModelTC.UpdateData(data, offset + 256);
        CV1PV2ModelTC.UpdateData(data, offset + 260);
        CV2PV2ModelTC.UpdateData(data, offset + 264);
        CV3PV2ModelTC.UpdateData(data, offset + 268);
        CV1PV1ModelDT.UpdateData(data, offset + 272);
        CV2PV1ModelDT.UpdateData(data, offset + 276);
        CV3PV1ModelDT.UpdateData(data, offset + 280);
        CV1PV2ModelDT.UpdateData(data, offset + 284);
        CV2PV2ModelDT.UpdateData(data, offset + 288);
        CV3PV2ModelDT.UpdateData(data, offset + 292);
        CV1PV1RespTC.UpdateData(data, offset + 296);
        CV2PV1RespTC.UpdateData(data, offset + 300);
        CV3PV1RespTC.UpdateData(data, offset + 304);
        CV1PV2RespTC.UpdateData(data, offset + 308);
        CV2PV2RespTC.UpdateData(data, offset + 312);
        CV3PV2RespTC.UpdateData(data, offset + 316);
        PV1Act1stCV.UpdateData(data, offset + 320);
        PV1Act2ndCV.UpdateData(data, offset + 324);
        PV1Act3rdCV.UpdateData(data, offset + 328);
        PV2Act1stCV.UpdateData(data, offset + 332);
        PV2Act2ndCV.UpdateData(data, offset + 336);
        PV2Act3rdCV.UpdateData(data, offset + 340);
        TargetCV.UpdateData(data, offset + 344);
        TargetRespTC.UpdateData(data, offset + 348);
        PVTracking.UpdateData((data[offset + 352] & (1 << 2)) != 0);
        ManualAfterInit.UpdateData((data[offset + 352] & (1 << 3)) != 0);
        ProgProgReq.UpdateData((data[offset + 352] & (1 << 4)) != 0);
        ProgOperReq.UpdateData((data[offset + 352] & (1 << 5)) != 0);
        ProgCV1AutoReq.UpdateData((data[offset + 352] & (1 << 6)) != 0);
        ProgCV2AutoReq.UpdateData((data[offset + 352] & (1 << 7)) != 0);
        ProgCV3AutoReq.UpdateData((data[offset + 353] & (1 << 0)) != 0);
        ProgCV1ManualReq.UpdateData((data[offset + 353] & (1 << 1)) != 0);
        ProgCV2ManualReq.UpdateData((data[offset + 353] & (1 << 2)) != 0);
        ProgCV3ManualReq.UpdateData((data[offset + 353] & (1 << 3)) != 0);
        ProgCV1OverrideReq.UpdateData((data[offset + 353] & (1 << 4)) != 0);
        ProgCV2OverrideReq.UpdateData((data[offset + 353] & (1 << 5)) != 0);
        ProgCV3OverrideReq.UpdateData((data[offset + 353] & (1 << 6)) != 0);
        ProgCV1HandReq.UpdateData((data[offset + 353] & (1 << 7)) != 0);
        ProgCV2HandReq.UpdateData((data[offset + 354] & (1 << 0)) != 0);
        ProgCV3HandReq.UpdateData((data[offset + 354] & (1 << 1)) != 0);
        OperProgReq.UpdateData((data[offset + 354] & (1 << 2)) != 0);
        OperOperReq.UpdateData((data[offset + 354] & (1 << 3)) != 0);
        OperCV1AutoReq.UpdateData((data[offset + 354] & (1 << 4)) != 0);
        OperCV2AutoReq.UpdateData((data[offset + 354] & (1 << 5)) != 0);
        OperCV3AutoReq.UpdateData((data[offset + 354] & (1 << 6)) != 0);
        OperCV1ManualReq.UpdateData((data[offset + 354] & (1 << 7)) != 0);
        OperCV2ManualReq.UpdateData((data[offset + 355] & (1 << 0)) != 0);
        OperCV3ManualReq.UpdateData((data[offset + 355] & (1 << 1)) != 0);
        ProgValueReset.UpdateData((data[offset + 355] & (1 << 2)) != 0);
        TimingMode.UpdateData(data, offset + 355);
        OversampleDT.UpdateData(data, offset + 359);
        RTSTime.UpdateData(data, offset + 363);
        RTSTimeStamp.UpdateData(data, offset + 367);
        PV1TuneLimit.UpdateData(data, offset + 371);
        PV2TuneLimit.UpdateData(data, offset + 375);
        PV1AtuneTimeLimit.UpdateData(data, offset + 379);
        PV2AtuneTimeLimit.UpdateData(data, offset + 383);
        PV1NoiseLevel.UpdateData(data, offset + 387);
        PV2NoiseLevel.UpdateData(data, offset + 391);
        CV1StepSize.UpdateData(data, offset + 395);
        CV2StepSize.UpdateData(data, offset + 399);
        CV3StepSize.UpdateData(data, offset + 403);
        CV1PV1ResponseSpeed.UpdateData(data, offset + 407);
        CV2PV1ResponseSpeed.UpdateData(data, offset + 411);
        CV3PV1ResponseSpeed.UpdateData(data, offset + 415);
        CV1PV2ResponseSpeed.UpdateData(data, offset + 419);
        CV2PV2ResponseSpeed.UpdateData(data, offset + 423);
        CV3PV2ResponseSpeed.UpdateData(data, offset + 427);
        CV1PV1ModelInit.UpdateData((data[offset + 431] & (1 << 3)) != 0);
        CV2PV1ModelInit.UpdateData((data[offset + 431] & (1 << 4)) != 0);
        CV3PV1ModelInit.UpdateData((data[offset + 431] & (1 << 5)) != 0);
        CV1PV2ModelInit.UpdateData((data[offset + 431] & (1 << 6)) != 0);
        CV2PV2ModelInit.UpdateData((data[offset + 431] & (1 << 7)) != 0);
        CV3PV2ModelInit.UpdateData((data[offset + 432] & (1 << 0)) != 0);
        PV1Factor.UpdateData(data, offset + 432);
        PV2Factor.UpdateData(data, offset + 436);
        AtuneCV1Start.UpdateData((data[offset + 444] & (1 << 1)) != 0);
        AtuneCV2Start.UpdateData((data[offset + 444] & (1 << 2)) != 0);
        AtuneCV3Start.UpdateData((data[offset + 444] & (1 << 3)) != 0);
        AtuneCV1PV1UseModel.UpdateData((data[offset + 444] & (1 << 4)) != 0);
        AtuneCV2PV1UseModel.UpdateData((data[offset + 444] & (1 << 5)) != 0);
        AtuneCV3PV1UseModel.UpdateData((data[offset + 444] & (1 << 6)) != 0);
        AtuneCV1PV2UseModel.UpdateData((data[offset + 444] & (1 << 7)) != 0);
        AtuneCV2PV2UseModel.UpdateData((data[offset + 445] & (1 << 0)) != 0);
        AtuneCV3PV2UseModel.UpdateData((data[offset + 445] & (1 << 1)) != 0);
        AtuneCV1Abort.UpdateData((data[offset + 445] & (1 << 2)) != 0);
        AtuneCV2Abort.UpdateData((data[offset + 445] & (1 << 3)) != 0);
        AtuneCV3Abort.UpdateData((data[offset + 445] & (1 << 4)) != 0);
        EnableOut.UpdateData((data[offset + 445] & (1 << 5)) != 0);
        CV1EU.UpdateData(data, offset + 461);
        CV2EU.UpdateData(data, offset + 465);
        CV3EU.UpdateData(data, offset + 469);
        CV1.UpdateData(data, offset + 473);
        CV2.UpdateData(data, offset + 477);
        CV3.UpdateData(data, offset + 481);
        CV1Initializing.UpdateData((data[offset + 485] & (1 << 6)) != 0);
        CV2Initializing.UpdateData((data[offset + 485] & (1 << 7)) != 0);
        CV3Initializing.UpdateData((data[offset + 486] & (1 << 0)) != 0);
        CV1HAlarm.UpdateData((data[offset + 486] & (1 << 1)) != 0);
        CV2HAlarm.UpdateData((data[offset + 486] & (1 << 2)) != 0);
        CV3HAlarm.UpdateData((data[offset + 486] & (1 << 3)) != 0);
        CV1LAlarm.UpdateData((data[offset + 486] & (1 << 4)) != 0);
        CV2LAlarm.UpdateData((data[offset + 486] & (1 << 5)) != 0);
        CV3LAlarm.UpdateData((data[offset + 486] & (1 << 6)) != 0);
        CV1ROCPosAlarm.UpdateData((data[offset + 486] & (1 << 7)) != 0);
        CV2ROCPosAlarm.UpdateData((data[offset + 487] & (1 << 0)) != 0);
        CV3ROCPosAlarm.UpdateData((data[offset + 487] & (1 << 1)) != 0);
        CV1ROCNegAlarm.UpdateData((data[offset + 487] & (1 << 2)) != 0);
        CV2ROCNegAlarm.UpdateData((data[offset + 487] & (1 << 3)) != 0);
        CV3ROCNegAlarm.UpdateData((data[offset + 487] & (1 << 4)) != 0);
        SP1.UpdateData(data, offset + 487);
        SP2.UpdateData(data, offset + 491);
        SP1Percent.UpdateData(data, offset + 495);
        SP2Percent.UpdateData(data, offset + 499);
        SP1HAlarm.UpdateData((data[offset + 503] & (1 << 5)) != 0);
        SP2HAlarm.UpdateData((data[offset + 503] & (1 << 6)) != 0);
        SP1LAlarm.UpdateData((data[offset + 503] & (1 << 7)) != 0);
        SP2LAlarm.UpdateData((data[offset + 504] & (1 << 0)) != 0);
        PV1Percent.UpdateData(data, offset + 504);
        PV2Percent.UpdateData(data, offset + 508);
        E1.UpdateData(data, offset + 512);
        E2.UpdateData(data, offset + 516);
        E1Percent.UpdateData(data, offset + 520);
        E2Percent.UpdateData(data, offset + 524);
        CV1WindupHOut.UpdateData((data[offset + 528] & (1 << 1)) != 0);
        CV2WindupHOut.UpdateData((data[offset + 528] & (1 << 2)) != 0);
        CV3WindupHOut.UpdateData((data[offset + 528] & (1 << 3)) != 0);
        CV1WindupLOut.UpdateData((data[offset + 528] & (1 << 4)) != 0);
        CV2WindupLOut.UpdateData((data[offset + 528] & (1 << 5)) != 0);
        CV3WindupLOut.UpdateData((data[offset + 528] & (1 << 6)) != 0);
        ProgOper.UpdateData((data[offset + 528] & (1 << 7)) != 0);
        CV1Auto.UpdateData((data[offset + 529] & (1 << 0)) != 0);
        CV2Auto.UpdateData((data[offset + 529] & (1 << 1)) != 0);
        CV3Auto.UpdateData((data[offset + 529] & (1 << 2)) != 0);
        CV1Manual.UpdateData((data[offset + 529] & (1 << 3)) != 0);
        CV2Manual.UpdateData((data[offset + 529] & (1 << 4)) != 0);
        CV3Manual.UpdateData((data[offset + 529] & (1 << 5)) != 0);
        CV1Override.UpdateData((data[offset + 529] & (1 << 6)) != 0);
        CV2Override.UpdateData((data[offset + 529] & (1 << 7)) != 0);
        CV3Override.UpdateData((data[offset + 530] & (1 << 0)) != 0);
        CV1Hand.UpdateData((data[offset + 530] & (1 << 1)) != 0);
        CV2Hand.UpdateData((data[offset + 530] & (1 << 2)) != 0);
        CV3Hand.UpdateData((data[offset + 530] & (1 << 3)) != 0);
        DeltaT.UpdateData(data, offset + 530);
        CV1StepSizeUsed.UpdateData(data, offset + 534);
        CV2StepSizeUsed.UpdateData(data, offset + 538);
        CV3StepSizeUsed.UpdateData(data, offset + 542);
        CV1PV1GainTuned.UpdateData(data, offset + 546);
        CV2PV1GainTuned.UpdateData(data, offset + 550);
        CV3PV1GainTuned.UpdateData(data, offset + 554);
        CV1PV2GainTuned.UpdateData(data, offset + 558);
        CV2PV2GainTuned.UpdateData(data, offset + 562);
        CV3PV2GainTuned.UpdateData(data, offset + 566);
        CV1PV1TCTuned.UpdateData(data, offset + 570);
        CV2PV1TCTuned.UpdateData(data, offset + 574);
        CV3PV1TCTuned.UpdateData(data, offset + 578);
        CV1PV2TCTuned.UpdateData(data, offset + 582);
        CV2PV2TCTuned.UpdateData(data, offset + 586);
        CV3PV2TCTuned.UpdateData(data, offset + 590);
        CV1PV1DTTuned.UpdateData(data, offset + 594);
        CV2PV1DTTuned.UpdateData(data, offset + 598);
        CV3PV1DTTuned.UpdateData(data, offset + 602);
        CV1PV2DTTuned.UpdateData(data, offset + 606);
        CV2PV2DTTuned.UpdateData(data, offset + 610);
        CV3PV2DTTuned.UpdateData(data, offset + 614);
        CV1PV1RespTCTunedS.UpdateData(data, offset + 618);
        CV2PV1RespTCTunedS.UpdateData(data, offset + 622);
        CV3PV1RespTCTunedS.UpdateData(data, offset + 626);
        CV1PV2RespTCTunedS.UpdateData(data, offset + 630);
        CV2PV2RespTCTunedS.UpdateData(data, offset + 634);
        CV3PV2RespTCTunedS.UpdateData(data, offset + 638);
        CV1PV1RespTCTunedM.UpdateData(data, offset + 642);
        CV2PV1RespTCTunedM.UpdateData(data, offset + 646);
        CV3PV1RespTCTunedM.UpdateData(data, offset + 650);
        CV1PV2RespTCTunedM.UpdateData(data, offset + 654);
        CV2PV2RespTCTunedM.UpdateData(data, offset + 658);
        CV3PV2RespTCTunedM.UpdateData(data, offset + 662);
        CV1PV1RespTCTunedF.UpdateData(data, offset + 666);
        CV2PV1RespTCTunedF.UpdateData(data, offset + 670);
        CV3PV1RespTCTunedF.UpdateData(data, offset + 674);
        CV1PV2RespTCTunedF.UpdateData(data, offset + 678);
        CV2PV2RespTCTunedF.UpdateData(data, offset + 682);
        CV3PV2RespTCTunedF.UpdateData(data, offset + 686);
        AtuneCV1PV1On.UpdateData((data[offset + 698] & (1 << 4)) != 0);
        AtuneCV2PV1On.UpdateData((data[offset + 698] & (1 << 5)) != 0);
        AtuneCV3PV1On.UpdateData((data[offset + 698] & (1 << 6)) != 0);
        AtuneCV1PV1Done.UpdateData((data[offset + 698] & (1 << 7)) != 0);
        AtuneCV2PV1Done.UpdateData((data[offset + 699] & (1 << 0)) != 0);
        AtuneCV3PV1Done.UpdateData((data[offset + 699] & (1 << 1)) != 0);
        AtuneCV1PV1Aborted.UpdateData((data[offset + 699] & (1 << 2)) != 0);
        AtuneCV2PV1Aborted.UpdateData((data[offset + 699] & (1 << 3)) != 0);
        AtuneCV3PV1Aborted.UpdateData((data[offset + 699] & (1 << 4)) != 0);
        AtuneCV1PV2On.UpdateData((data[offset + 699] & (1 << 5)) != 0);
        AtuneCV2PV2On.UpdateData((data[offset + 699] & (1 << 6)) != 0);
        AtuneCV3PV2On.UpdateData((data[offset + 699] & (1 << 7)) != 0);
        AtuneCV1PV2Done.UpdateData((data[offset + 700] & (1 << 0)) != 0);
        AtuneCV2PV2Done.UpdateData((data[offset + 700] & (1 << 1)) != 0);
        AtuneCV3PV2Done.UpdateData((data[offset + 700] & (1 << 2)) != 0);
        AtuneCV1PV2Aborted.UpdateData((data[offset + 700] & (1 << 3)) != 0);
        AtuneCV2PV2Aborted.UpdateData((data[offset + 700] & (1 << 4)) != 0);
        AtuneCV3PV2Aborted.UpdateData((data[offset + 700] & (1 << 5)) != 0);
        AtuneCV1PV1Status.UpdateData(data, offset + 700);
        AtuneCV2PV1Status.UpdateData(data, offset + 704);
        AtuneCV3PV1Status.UpdateData(data, offset + 708);
        AtuneCV1PV2Status.UpdateData(data, offset + 712);
        AtuneCV2PV2Status.UpdateData(data, offset + 716);
        AtuneCV3PV2Status.UpdateData(data, offset + 720);
        AtuneCV1PV1Fault.UpdateData((data[offset + 724] & (1 << 6)) != 0);
        AtuneCV1PV1OutOfLimit.UpdateData((data[offset + 724] & (1 << 7)) != 0);
        AtuneCV1PV1ModeInv.UpdateData((data[offset + 725] & (1 << 0)) != 0);
        AtuneCV1PV1WindupFault.UpdateData((data[offset + 725] & (1 << 1)) != 0);
        AtuneCV1PV1StepSize0.UpdateData((data[offset + 725] & (1 << 2)) != 0);
        AtuneCV1PV1LimitsFault.UpdateData((data[offset + 725] & (1 << 3)) != 0);
        AtuneCV1PV1InitFault.UpdateData((data[offset + 725] & (1 << 4)) != 0);
        AtuneCV1PV1EUSpanChanged.UpdateData((data[offset + 725] & (1 << 5)) != 0);
        AtuneCV1PV1Changed.UpdateData((data[offset + 725] & (1 << 6)) != 0);
        AtuneCV1PV1Timeout.UpdateData((data[offset + 725] & (1 << 7)) != 0);
        AtuneCV1PV1NotSettled.UpdateData((data[offset + 726] & (1 << 0)) != 0);
        AtuneCV2PV1Fault.UpdateData((data[offset + 726] & (1 << 1)) != 0);
        AtuneCV2PV1OutOfLimit.UpdateData((data[offset + 726] & (1 << 2)) != 0);
        AtuneCV2PV1ModeInv.UpdateData((data[offset + 726] & (1 << 3)) != 0);
        AtuneCV2PV1WindupFault.UpdateData((data[offset + 726] & (1 << 4)) != 0);
        AtuneCV2PV1StepSize0.UpdateData((data[offset + 726] & (1 << 5)) != 0);
        AtuneCV2PV1LimitsFault.UpdateData((data[offset + 726] & (1 << 6)) != 0);
        AtuneCV2PV1InitFault.UpdateData((data[offset + 726] & (1 << 7)) != 0);
        AtuneCV2PV1EUSpanChanged.UpdateData((data[offset + 727] & (1 << 0)) != 0);
        AtuneCV2PV1Changed.UpdateData((data[offset + 727] & (1 << 1)) != 0);
        AtuneCV2PV1Timeout.UpdateData((data[offset + 727] & (1 << 2)) != 0);
        AtuneCV2PV1NotSettled.UpdateData((data[offset + 727] & (1 << 3)) != 0);
        AtuneCV3PV1Fault.UpdateData((data[offset + 727] & (1 << 4)) != 0);
        AtuneCV3PV1OutOfLimit.UpdateData((data[offset + 727] & (1 << 5)) != 0);
        AtuneCV3PV1ModeInv.UpdateData((data[offset + 727] & (1 << 6)) != 0);
        AtuneCV3PV1WindupFault.UpdateData((data[offset + 727] & (1 << 7)) != 0);
        AtuneCV3PV1StepSize0.UpdateData((data[offset + 728] & (1 << 0)) != 0);
        AtuneCV3PV1LimitsFault.UpdateData((data[offset + 728] & (1 << 1)) != 0);
        AtuneCV3PV1InitFault.UpdateData((data[offset + 728] & (1 << 2)) != 0);
        AtuneCV3PV1EUSpanChanged.UpdateData((data[offset + 728] & (1 << 3)) != 0);
        AtuneCV3PV1Changed.UpdateData((data[offset + 728] & (1 << 4)) != 0);
        AtuneCV3PV1Timeout.UpdateData((data[offset + 728] & (1 << 5)) != 0);
        AtuneCV3PV1NotSettled.UpdateData((data[offset + 728] & (1 << 6)) != 0);
        AtuneCV1PV2Fault.UpdateData((data[offset + 728] & (1 << 7)) != 0);
        AtuneCV1PV2OutOfLimit.UpdateData((data[offset + 729] & (1 << 0)) != 0);
        AtuneCV1PV2ModeInv.UpdateData((data[offset + 729] & (1 << 1)) != 0);
        AtuneCV1PV2WindupFault.UpdateData((data[offset + 729] & (1 << 2)) != 0);
        AtuneCV1PV2StepSize0.UpdateData((data[offset + 729] & (1 << 3)) != 0);
        AtuneCV1PV2LimitsFault.UpdateData((data[offset + 729] & (1 << 4)) != 0);
        AtuneCV1PV2InitFault.UpdateData((data[offset + 729] & (1 << 5)) != 0);
        AtuneCV1PV2EUSpanChanged.UpdateData((data[offset + 729] & (1 << 6)) != 0);
        AtuneCV1PV2Changed.UpdateData((data[offset + 729] & (1 << 7)) != 0);
        AtuneCV1PV2Timeout.UpdateData((data[offset + 730] & (1 << 0)) != 0);
        AtuneCV1PV2NotSettled.UpdateData((data[offset + 730] & (1 << 1)) != 0);
        AtuneCV2PV2Fault.UpdateData((data[offset + 730] & (1 << 2)) != 0);
        AtuneCV2PV2OutOfLimit.UpdateData((data[offset + 730] & (1 << 3)) != 0);
        AtuneCV2PV2ModeInv.UpdateData((data[offset + 730] & (1 << 4)) != 0);
        AtuneCV2PV2WindupFault.UpdateData((data[offset + 730] & (1 << 5)) != 0);
        AtuneCV2PV2StepSize0.UpdateData((data[offset + 730] & (1 << 6)) != 0);
        AtuneCV2PV2LimitsFault.UpdateData((data[offset + 730] & (1 << 7)) != 0);
        AtuneCV2PV2InitFault.UpdateData((data[offset + 731] & (1 << 0)) != 0);
        AtuneCV2PV2EUSpanChanged.UpdateData((data[offset + 731] & (1 << 1)) != 0);
        AtuneCV2PV2Changed.UpdateData((data[offset + 731] & (1 << 2)) != 0);
        AtuneCV2PV2Timeout.UpdateData((data[offset + 731] & (1 << 3)) != 0);
        AtuneCV2PV2NotSettled.UpdateData((data[offset + 731] & (1 << 4)) != 0);
        AtuneCV3PV2Fault.UpdateData((data[offset + 731] & (1 << 5)) != 0);
        AtuneCV3PV2OutOfLimit.UpdateData((data[offset + 731] & (1 << 6)) != 0);
        AtuneCV3PV2ModeInv.UpdateData((data[offset + 731] & (1 << 7)) != 0);
        AtuneCV3PV2WindupFault.UpdateData((data[offset + 732] & (1 << 0)) != 0);
        AtuneCV3PV2StepSize0.UpdateData((data[offset + 732] & (1 << 1)) != 0);
        AtuneCV3PV2LimitsFault.UpdateData((data[offset + 732] & (1 << 2)) != 0);
        AtuneCV3PV2InitFault.UpdateData((data[offset + 732] & (1 << 3)) != 0);
        AtuneCV3PV2EUSpanChanged.UpdateData((data[offset + 732] & (1 << 4)) != 0);
        AtuneCV3PV2Changed.UpdateData((data[offset + 732] & (1 << 5)) != 0);
        AtuneCV3PV2Timeout.UpdateData((data[offset + 732] & (1 << 6)) != 0);
        AtuneCV3PV2NotSettled.UpdateData((data[offset + 732] & (1 << 7)) != 0);
        Status1.UpdateData(data, offset + 732);
        Status2.UpdateData(data, offset + 736);
        Status3CV1.UpdateData(data, offset + 740);
        Status3CV2.UpdateData(data, offset + 744);
        Status3CV3.UpdateData(data, offset + 748);
        InstructFault.UpdateData((data[offset + 753] & (1 << 0)) != 0);
        PV1Faulted.UpdateData((data[offset + 753] & (1 << 1)) != 0);
        PV2Faulted.UpdateData((data[offset + 753] & (1 << 2)) != 0);
        PV1SpanInv.UpdateData((data[offset + 753] & (1 << 3)) != 0);
        PV2SpanInv.UpdateData((data[offset + 753] & (1 << 4)) != 0);
        SP1ProgInv.UpdateData((data[offset + 753] & (1 << 5)) != 0);
        SP2ProgInv.UpdateData((data[offset + 753] & (1 << 6)) != 0);
        SP1OperInv.UpdateData((data[offset + 753] & (1 << 7)) != 0);
        SP2OperInv.UpdateData((data[offset + 754] & (1 << 0)) != 0);
        SP1LimitsInv.UpdateData((data[offset + 754] & (1 << 1)) != 0);
        SP2LimitsInv.UpdateData((data[offset + 754] & (1 << 2)) != 0);
        SampleTimeTooSmall.UpdateData((data[offset + 754] & (1 << 3)) != 0);
        PV1FactorInv.UpdateData((data[offset + 754] & (1 << 4)) != 0);
        PV2FactorInv.UpdateData((data[offset + 754] & (1 << 5)) != 0);
        TimingModeInv.UpdateData((data[offset + 754] & (1 << 6)) != 0);
        RTSMissed.UpdateData((data[offset + 754] & (1 << 7)) != 0);
        RTSTimeInv.UpdateData((data[offset + 755] & (1 << 0)) != 0);
        RTSTimeStampInv.UpdateData((data[offset + 755] & (1 << 1)) != 0);
        DeltaTInv.UpdateData((data[offset + 755] & (1 << 2)) != 0);
        CV1Faulted.UpdateData((data[offset + 755] & (1 << 3)) != 0);
        CV1HandFBFaulted.UpdateData((data[offset + 755] & (1 << 4)) != 0);
        CV1ProgInv.UpdateData((data[offset + 755] & (1 << 5)) != 0);
        CV1OperInv.UpdateData((data[offset + 755] & (1 << 6)) != 0);
        CV1OverrideValueInv.UpdateData((data[offset + 755] & (1 << 7)) != 0);
        CV1EUSpanInv.UpdateData((data[offset + 756] & (1 << 0)) != 0);
        CV1LimitsInv.UpdateData((data[offset + 756] & (1 << 1)) != 0);
        CV1ROCLimitInv.UpdateData((data[offset + 756] & (1 << 2)) != 0);
        CV1HandFBInv.UpdateData((data[offset + 756] & (1 << 3)) != 0);
        CV1PV1ModelGainInv.UpdateData((data[offset + 756] & (1 << 4)) != 0);
        CV1PV2ModelGainInv.UpdateData((data[offset + 756] & (1 << 5)) != 0);
        CV1PV1ModelTCInv.UpdateData((data[offset + 756] & (1 << 6)) != 0);
        CV1PV2ModelTCInv.UpdateData((data[offset + 756] & (1 << 7)) != 0);
        CV1PV1ModelDTInv.UpdateData((data[offset + 757] & (1 << 0)) != 0);
        CV1PV2ModelDTInv.UpdateData((data[offset + 757] & (1 << 1)) != 0);
        CV1PV1RespTCInv.UpdateData((data[offset + 757] & (1 << 2)) != 0);
        CV1PV2RespTCInv.UpdateData((data[offset + 757] & (1 << 3)) != 0);
        CV1TargetInv.UpdateData((data[offset + 757] & (1 << 4)) != 0);
        CV2Faulted.UpdateData((data[offset + 757] & (1 << 5)) != 0);
        CV2HandFBFaulted.UpdateData((data[offset + 757] & (1 << 6)) != 0);
        CV2ProgInv.UpdateData((data[offset + 757] & (1 << 7)) != 0);
        CV2OperInv.UpdateData((data[offset + 758] & (1 << 0)) != 0);
        CV2OverrideValueInv.UpdateData((data[offset + 758] & (1 << 1)) != 0);
        CV2EUSpanInv.UpdateData((data[offset + 758] & (1 << 2)) != 0);
        CV2LimitsInv.UpdateData((data[offset + 758] & (1 << 3)) != 0);
        CV2ROCLimitInv.UpdateData((data[offset + 758] & (1 << 4)) != 0);
        CV2HandFBInv.UpdateData((data[offset + 758] & (1 << 5)) != 0);
        CV2PV1ModelGainInv.UpdateData((data[offset + 758] & (1 << 6)) != 0);
        CV2PV2ModelGainInv.UpdateData((data[offset + 758] & (1 << 7)) != 0);
        CV2PV1ModelTCInv.UpdateData((data[offset + 759] & (1 << 0)) != 0);
        CV2PV2ModelTCInv.UpdateData((data[offset + 759] & (1 << 1)) != 0);
        CV2PV1ModelDTInv.UpdateData((data[offset + 759] & (1 << 2)) != 0);
        CV2PV2ModelDTInv.UpdateData((data[offset + 759] & (1 << 3)) != 0);
        CV2PV1RespTCInv.UpdateData((data[offset + 759] & (1 << 4)) != 0);
        CV2PV2RespTCInv.UpdateData((data[offset + 759] & (1 << 5)) != 0);
        CV2TargetInv.UpdateData((data[offset + 759] & (1 << 6)) != 0);
        CV3Faulted.UpdateData((data[offset + 759] & (1 << 7)) != 0);
        CV3HandFBFaulted.UpdateData((data[offset + 760] & (1 << 0)) != 0);
        CV3ProgInv.UpdateData((data[offset + 760] & (1 << 1)) != 0);
        CV3OperInv.UpdateData((data[offset + 760] & (1 << 2)) != 0);
        CV3OverrideValueInv.UpdateData((data[offset + 760] & (1 << 3)) != 0);
        CV3EUSpanInv.UpdateData((data[offset + 760] & (1 << 4)) != 0);
        CV3LimitsInv.UpdateData((data[offset + 760] & (1 << 5)) != 0);
        CV3ROCLimitInv.UpdateData((data[offset + 760] & (1 << 6)) != 0);
        CV3HandFBInv.UpdateData((data[offset + 760] & (1 << 7)) != 0);
        CV3PV1ModelGainInv.UpdateData((data[offset + 761] & (1 << 0)) != 0);
        CV3PV2ModelGainInv.UpdateData((data[offset + 761] & (1 << 1)) != 0);
        CV3PV1ModelTCInv.UpdateData((data[offset + 761] & (1 << 2)) != 0);
        CV3PV2ModelTCInv.UpdateData((data[offset + 761] & (1 << 3)) != 0);
        CV3PV1ModelDTInv.UpdateData((data[offset + 761] & (1 << 4)) != 0);
        CV3PV2ModelDTInv.UpdateData((data[offset + 761] & (1 << 5)) != 0);
        CV3PV1RespTCInv.UpdateData((data[offset + 761] & (1 << 6)) != 0);
        CV3PV2RespTCInv.UpdateData((data[offset + 761] & (1 << 7)) != 0);
        CV3TargetInv.UpdateData((data[offset + 762] & (1 << 0)) != 0);
