...
public sealed partial class CHANNEL_AI_NAMUR_I_0 : StructureData
{
    ...
    {
        Fault.UpdateData((data[offset + 2] & (1 << 0)) != 0);
        Uncertain.UpdateData((data[offset + 2] & (1 << 1)) != 0);
        Underrange.UpdateData((data[offset + 2] & (1 << 2)) != 0);
        Overrange.UpdateData((data[offset + 2] & (1 << 3)) != 0);
        LowSaturation.UpdateData((data[offset + 2] & (1 << 4)) != 0);
        HighSaturation.UpdateData((data[offset + 2] & (1 << 5)) != 0);
