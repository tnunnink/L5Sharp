...
public sealed partial class P_VALVE_DISCRETE : StructureData
{
    ...
    /// </remarks>
    public override int GetSize() => 480;
    ...
    public override int UpdateData(byte[] data, int offset)
    {
        ...
        Inp_OvrdCmd.UpdateData(data, offset + 5);
        Inp_Pos1FdbkData.UpdateData((data[offset + 6] & (1 << 3)) != 0);
        Inp_Pos2FdbkData.UpdateData((data[offset + 6] & (1 << 4)) != 0);
        Inp_ActuatorFault.UpdateData((data[offset + 6] & (1 << 5)) != 0);
        Inp_IOFault.UpdateData((data[offset + 6] & (1 << 6)) != 0);
        Inp_Pos1PermOK.UpdateData((data[offset + 6] & (1 << 7)) != 0);
        Inp_Pos1NBPermOK.UpdateData((data[offset + 7] & (1 << 0)) != 0);
        Inp_Pos2PermOK.UpdateData((data[offset + 7] & (1 << 1)) != 0);
        Inp_Pos2NBPermOK.UpdateData((data[offset + 7] & (1 << 2)) != 0);
        Inp_IntlkOK.UpdateData((data[offset + 7] & (1 << 3)) != 0);
        Inp_NBIntlkOK.UpdateData((data[offset + 7] & (1 << 4)) != 0);
        Inp_IntlkAvailable.UpdateData((data[offset + 7] & (1 << 5)) != 0);
        Inp_IntlkTripInh.UpdateData((data[offset + 7] & (1 << 6)) != 0);
        Inp_RdyReset.UpdateData((data[offset + 7] & (1 << 7)) != 0);
        Inp_Hand.UpdateData((data[offset + 8] & (1 << 0)) != 0);
        Inp_Ovrd.UpdateData((data[offset + 8] & (1 << 1)) != 0);
        Inp_OwnerCmd.UpdateData(data, offset + 8);
        Inp_ExtInh.UpdateData((data[offset + 12] & (1 << 2)) != 0);
        Inp_HornInh.UpdateData((data[offset + 12] & (1 << 3)) != 0);
        Inp_Reset.UpdateData((data[offset + 12] & (1 << 4)) != 0);
        Inp_VirtualPos1HO.UpdateData((data[offset + 12] & (1 << 5)) != 0);
        Inp_VirtualPos2HO.UpdateData((data[offset + 12] & (1 << 6)) != 0);
        Cfg_AllowDisable.UpdateData((data[offset + 12] & (1 << 7)) != 0);
        Cfg_AllowShelve.UpdateData((data[offset + 13] & (1 << 0)) != 0);
        Cfg_eObjType.UpdateData(data, offset + 13);
        Cfg_HasPos1Fdbk.UpdateData((data[offset + 14] & (1 << 1)) != 0);
        Cfg_HasPos2Fdbk.UpdateData((data[offset + 14] & (1 << 2)) != 0);
        Cfg_UsePos1Fdbk.UpdateData((data[offset + 14] & (1 << 3)) != 0);
        Cfg_UsePos2Fdbk.UpdateData((data[offset + 14] & (1 << 4)) != 0);
        Cfg_HasPos1PermObj.UpdateData((data[offset + 14] & (1 << 5)) != 0);
        Cfg_HasPos2PermObj.UpdateData((data[offset + 14] & (1 << 6)) != 0);
        Cfg_HasIntlkObj.UpdateData((data[offset + 14] & (1 << 7)) != 0);
        Cfg_FailPos2.UpdateData((data[offset + 15] & (1 << 0)) != 0);
        Cfg_FdbkFail.UpdateData((data[offset + 15] & (1 << 1)) != 0);
        Cfg_HasStop.UpdateData((data[offset + 15] & (1 << 2)) != 0);
        Cfg_MntnOut.UpdateData((data[offset + 19] & (1 << 3)) != 0);
        Cfg_MntnOutAlm.UpdateData((data[offset + 19] & (1 << 4)) != 0);
        Cfg_MntnStop.UpdateData((data[offset + 19] & (1 << 5)) != 0);
        Cfg_HasTrip.UpdateData((data[offset + 19] & (1 << 6)) != 0);
        Cfg_TripPos2.UpdateData((data[offset + 19] & (1 << 7)) != 0);
        Cfg_HasPulse.UpdateData((data[offset + 20] & (1 << 0)) != 0);
        Cfg_CompletePulse.UpdateData((data[offset + 20] & (1 << 1)) != 0);
        Cfg_HasPulseToState.UpdateData((data[offset + 20] & (1 << 2)) != 0);
        Cfg_HasMoreObj.UpdateData((data[offset + 20] & (1 << 3)) != 0);
        Cfg_HasStatsObj.UpdateData((data[offset + 20] & (1 << 4)) != 0);
        Cfg_CoastToLS.UpdateData((data[offset + 20] & (1 << 5)) != 0);
        Cfg_OperPos1Prio.UpdateData((data[offset + 20] & (1 << 6)) != 0);
        Cfg_OCmdResets.UpdateData((data[offset + 20] & (1 << 7)) != 0);
        Cfg_XCmdResets.UpdateData((data[offset + 21] & (1 << 0)) != 0);
        Cfg_OvrdPermIntlk.UpdateData((data[offset + 21] & (1 << 1)) != 0);
        Cfg_PCmdPos2AsLevel.UpdateData((data[offset + 21] & (1 << 2)) != 0);
        Cfg_ShedOnActuatorFault.UpdateData((data[offset + 21] & (1 << 3)) != 0);
        Cfg_ShedOnIOFault.UpdateData((data[offset + 21] & (1 << 4)) != 0);
        Cfg_ShedOnFailToTrip.UpdateData((data[offset + 21] & (1 << 5)) != 0);
        Cfg_ShedOnFullStall.UpdateData((data[offset + 21] & (1 << 6)) != 0);
        Cfg_ShedOnLossPos1.UpdateData((data[offset + 21] & (1 << 7)) != 0);
        Cfg_ShedOnLossPos2.UpdateData((data[offset + 22] & (1 << 0)) != 0);
        Cfg_ShedOnTransitStall.UpdateData((data[offset + 22] & (1 << 1)) != 0);
        Cfg_HasOper.UpdateData((data[offset + 22] & (1 << 2)) != 0);
        Cfg_HasOperLocked.UpdateData((data[offset + 22] & (1 << 3)) != 0);
        Cfg_HasProg.UpdateData((data[offset + 22] & (1 << 4)) != 0);
        Cfg_HasProgLocked.UpdateData((data[offset + 22] & (1 << 5)) != 0);
        Cfg_HasExt.UpdateData((data[offset + 22] & (1 << 6)) != 0);
        Cfg_HasMaint.UpdateData((data[offset + 22] & (1 << 7)) != 0);
        Cfg_HasMaintOoS.UpdateData((data[offset + 23] & (1 << 0)) != 0);
        Cfg_OvrdOverLock.UpdateData((data[offset + 23] & (1 << 1)) != 0);
        Cfg_ExtOverLock.UpdateData((data[offset + 23] & (1 << 2)) != 0);
        Cfg_ProgPwrUp.UpdateData((data[offset + 23] & (1 << 3)) != 0);
        Cfg_ProgNormal.UpdateData((data[offset + 23] & (1 << 4)) != 0);
        Cfg_PCmdPriority.UpdateData((data[offset + 23] & (1 << 5)) != 0);
        Cfg_PCmdProgAsLevel.UpdateData((data[offset + 23] & (1 << 6)) != 0);
        Cfg_PCmdLockAsLevel.UpdateData((data[offset + 23] & (1 << 7)) != 0);
        Cfg_ExtAcqAsLevel.UpdateData((data[offset + 24] & (1 << 0)) != 0);
        Cfg_Pos1Dly.UpdateData(data, offset + 24);
        Cfg_Pos2Dly.UpdateData(data, offset + 28);
        Cfg_Pos1PulseTime.UpdateData(data, offset + 32);
        Cfg_Pos2PulseTime.UpdateData(data, offset + 36);
        Cfg_OutPulseTime.UpdateData(data, offset + 40);
        Cfg_StartHornTime.UpdateData(data, offset + 44);
        Cfg_FullStallTime.UpdateData(data, offset + 48);
        Cfg_TransitStallTime.UpdateData(data, offset + 52);
        Cfg_TripFailTime.UpdateData(data, offset + 56);
        Cfg_VirtualFdbkTime.UpdateData(data, offset + 60);
        Cfg_CnfrmReqd.UpdateData(data, offset + 64);
        PCmd_Pos1.UpdateData((data[offset + 65] & (1 << 1)) != 0);
        PCmd_Pos2.UpdateData((data[offset + 65] & (1 << 2)) != 0);
        PCmd_Pos1Pulse.UpdateData((data[offset + 65] & (1 << 3)) != 0);
        PCmd_Pos2Pulse.UpdateData((data[offset + 65] & (1 << 4)) != 0);
        PCmd_ContPulse.UpdateData((data[offset + 65] & (1 << 5)) != 0);
        PCmd_Trip.UpdateData((data[offset + 65] & (1 << 6)) != 0);
        PCmd_Reset.UpdateData((data[offset + 65] & (1 << 7)) != 0);
        PCmd_Stop.UpdateData((data[offset + 66] & (1 << 0)) != 0);
        PSet_Owner.UpdateData(data, offset + 66);
        PCmd_Lock.UpdateData((data[offset + 70] & (1 << 1)) != 0);
        PCmd_Normal.UpdateData((data[offset + 70] & (1 << 2)) != 0);
        PCmd_Oper.UpdateData((data[offset + 70] & (1 << 3)) != 0);
        PCmd_Prog.UpdateData((data[offset + 70] & (1 << 4)) != 0);
        PCmd_Unlock.UpdateData((data[offset + 70] & (1 << 5)) != 0);
        PCmd_Virtual.UpdateData((data[offset + 70] & (1 << 6)) != 0);
        PCmd_Physical.UpdateData((data[offset + 74] & (1 << 7)) != 0);
        XCmd_Pos1.UpdateData((data[offset + 75] & (1 << 0)) != 0);
        XCmd_Pos2.UpdateData((data[offset + 75] & (1 << 1)) != 0);
        XCmd_Pos1Pulse.UpdateData((data[offset + 75] & (1 << 2)) != 0);
        XCmd_Pos2Pulse.UpdateData((data[offset + 75] & (1 << 3)) != 0);
        XCmd_ContPulse.UpdateData((data[offset + 75] & (1 << 4)) != 0);
        XCmd_Trip.UpdateData((data[offset + 75] & (1 << 5)) != 0);
        XCmd_Reset.UpdateData((data[offset + 75] & (1 << 6)) != 0);
        XCmd_Stop.UpdateData((data[offset + 75] & (1 << 7)) != 0);
        XCmd_ResetAckAll.UpdateData((data[offset + 76] & (1 << 0)) != 0);
        XCmd_Acq.UpdateData((data[offset + 76] & (1 << 1)) != 0);
        XCmd_Rel.UpdateData((data[offset + 76] & (1 << 2)) != 0);
        Out_Pos1Data.UpdateData((data[offset + 76] & (1 << 3)) != 0);
        Out_Pos2Data.UpdateData((data[offset + 76] & (1 << 4)) != 0);
        Out_StopData.UpdateData((data[offset + 76] & (1 << 5)) != 0);
        Out_TripData.UpdateData((data[offset + 76] & (1 << 6)) != 0);
        Out_HornData.UpdateData((data[offset + 76] & (1 << 7)) != 0);
        Out_Reset.UpdateData((data[offset + 77] & (1 << 0)) != 0);
        Out_OwnerSts.UpdateData(data, offset + 77);
        Sts_Initialized.UpdateData((data[offset + 81] & (1 << 1)) != 0);
        Sts_Available.UpdateData((data[offset + 81] & (1 << 2)) != 0);
        Sts_IntlkAvailable.UpdateData((data[offset + 81] & (1 << 3)) != 0);
        Sts_Bypass.UpdateData((data[offset + 81] & (1 << 4)) != 0);
        Sts_BypActive.UpdateData((data[offset + 81] & (1 << 5)) != 0);
        Sts_MaintByp.UpdateData((data[offset + 81] & (1 << 6)) != 0);
        Sts_NotRdy.UpdateData((data[offset + 81] & (1 << 7)) != 0);
        Sts_NrdyCfgErr.UpdateData((data[offset + 82] & (1 << 0)) != 0);
        Sts_NrdyIntlk.UpdateData((data[offset + 82] & (1 << 1)) != 0);
        Sts_NrdyOoS.UpdateData((data[offset + 82] & (1 << 2)) != 0);
        Sts_NrdyPos1Perm.UpdateData((data[offset + 82] & (1 << 3)) != 0);
        Sts_NrdyPos2Perm.UpdateData((data[offset + 82] & (1 << 4)) != 0);
        Sts_NrdyPerm.UpdateData((data[offset + 82] & (1 << 5)) != 0);
        Sts_NrdyStopPerm.UpdateData((data[offset + 82] & (1 << 6)) != 0);
        Sts_Err.UpdateData((data[offset + 82] & (1 << 7)) != 0);
        Sts_ErrAlm.UpdateData((data[offset + 83] & (1 << 0)) != 0);
        Sts_ErrFullStallTime.UpdateData((data[offset + 87] & (1 << 1)) != 0);
        Sts_ErrHas.UpdateData((data[offset + 87] & (1 << 2)) != 0);
        Sts_ErrOutPulseTime.UpdateData((data[offset + 87] & (1 << 3)) != 0);
        Sts_ErrPos1Dly.UpdateData((data[offset + 87] & (1 << 4)) != 0);
        Sts_ErrPos1PulseTime.UpdateData((data[offset + 87] & (1 << 5)) != 0);
        Sts_ErrPos2Dly.UpdateData((data[offset + 87] & (1 << 6)) != 0);
        Sts_ErrPos2PulseTime.UpdateData((data[offset + 87] & (1 << 7)) != 0);
        Sts_ErrTransitStallTime.UpdateData((data[offset + 88] & (1 << 0)) != 0);
        Sts_ErrTripFailTime.UpdateData((data[offset + 88] & (1 << 1)) != 0);
        Sts_Hand.UpdateData((data[offset + 88] & (1 << 2)) != 0);
        Sts_OoS.UpdateData((data[offset + 88] & (1 << 3)) != 0);
        Sts_Maint.UpdateData((data[offset + 88] & (1 << 4)) != 0);
        Sts_Ovrd.UpdateData((data[offset + 88] & (1 << 5)) != 0);
        Sts_Ext.UpdateData((data[offset + 88] & (1 << 6)) != 0);
        Sts_Prog.UpdateData((data[offset + 88] & (1 << 7)) != 0);
        Sts_ProgLocked.UpdateData((data[offset + 89] & (1 << 0)) != 0);
        Sts_Oper.UpdateData((data[offset + 89] & (1 << 1)) != 0);
        Sts_OperLocked.UpdateData((data[offset + 89] & (1 << 2)) != 0);
        Sts_ProgOperSel.UpdateData((data[offset + 89] & (1 << 3)) != 0);
        Sts_ProgOperLock.UpdateData((data[offset + 89] & (1 << 4)) != 0);
        Sts_Normal.UpdateData((data[offset + 89] & (1 << 5)) != 0);
        Sts_ExtReqInh.UpdateData((data[offset + 89] & (1 << 6)) != 0);
        Sts_ProgReqInh.UpdateData((data[offset + 89] & (1 << 7)) != 0);
        Sts_MAcqRcvd.UpdateData((data[offset + 90] & (1 << 0)) != 0);
        Sts_CmdConflict.UpdateData((data[offset + 90] & (1 << 1)) != 0);
        Sts_Alm.UpdateData((data[offset + 90] & (1 << 2)) != 0);
        Sts_AlmInh.UpdateData((data[offset + 90] & (1 << 3)) != 0);
        Sts_ActuatorFault.UpdateData((data[offset + 90] & (1 << 4)) != 0);
        Sts_CmdToPos1.UpdateData((data[offset + 90] & (1 << 5)) != 0);
        Sts_CmdToPos2.UpdateData((data[offset + 90] & (1 << 6)) != 0);
        Sts_ErrUse.UpdateData((data[offset + 90] & (1 << 7)) != 0);
        Sts_ErrVirtualFdbkTime.UpdateData((data[offset + 91] & (1 << 0)) != 0);
        Sts_FdbkPos1.UpdateData((data[offset + 91] & (1 << 1)) != 0);
        Sts_FdbkPos2.UpdateData((data[offset + 91] & (1 << 2)) != 0);
        Sts_FdbkFail.UpdateData((data[offset + 91] & (1 << 3)) != 0);
        Sts_FullStall.UpdateData((data[offset + 91] & (1 << 4)) != 0);
        Sts_Horn.UpdateData((data[offset + 91] & (1 << 5)) != 0);
        Sts_LossPos1.UpdateData((data[offset + 91] & (1 << 6)) != 0);
        Sts_LossPos2.UpdateData((data[offset + 91] & (1 << 7)) != 0);
        Sts_IOFault.UpdateData((data[offset + 92] & (1 << 0)) != 0);
        Sts_Moving.UpdateData((data[offset + 92] & (1 << 1)) != 0);
        Sts_MovingToPos1.UpdateData((data[offset + 92] & (1 << 2)) != 0);
        Sts_MovingToPos2.UpdateData((data[offset + 92] & (1 << 3)) != 0);
        Sts_Pos1.UpdateData((data[offset + 92] & (1 << 4)) != 0);
        Sts_Pos2.UpdateData((data[offset + 92] & (1 << 5)) != 0);
        Sts_Pulsing.UpdateData((data[offset + 92] & (1 << 6)) != 0);
        Sts_Stopped.UpdateData((data[offset + 92] & (1 << 7)) != 0);
        Sts_TransitStall.UpdateData((data[offset + 97] & (1 << 0)) != 0);
        Sts_TripFail.UpdateData((data[offset + 97] & (1 << 1)) != 0);
        Sts_Tripping.UpdateData((data[offset + 97] & (1 << 2)) != 0);
        Sts_UnackAlmCount.UpdateData(data, offset + 97);
        Sts_NrdyTrip.UpdateData((data[offset + 101] & (1 << 3)) != 0);
        Sts_NrdyIOFault.UpdateData((data[offset + 101] & (1 << 4)) != 0);
        Sts_NrdyActuatorFault.UpdateData((data[offset + 101] & (1 << 5)) != 0);
        Sts_IntlkTrip.UpdateData((data[offset + 101] & (1 << 6)) != 0);
        Sts_NrdyFail.UpdateData((data[offset + 101] & (1 << 7)) != 0);
        Sts_RdyAck.UpdateData((data[offset + 102] & (1 << 0)) != 0);
        Sts_RdyReset.UpdateData((data[offset + 102] & (1 << 1)) != 0);
        Sts_Virtual.UpdateData((data[offset + 102] & (1 << 2)) != 0);
        Sts_bSrc.UpdateData(data, offset + 102);
        Sts_eSrc.UpdateData(data, offset + 104);
        Sts_eCmd.UpdateData(data, offset + 106);
        Sts_eFdbk.UpdateData(data, offset + 107);
        Sts_eFault.UpdateData(data, offset + 108);
        Sts_eNotify.UpdateData(data, offset + 109);
        Sts_eNotifyAll.UpdateData(data, offset + 110);
        Sts_eState.UpdateData(data, offset + 111);
        Sts_eSts.UpdateData(data, offset + 115);
        Sts_eNotifyActuatorFault.UpdateData(data, offset + 116);
        Sts_eNotifyFullStall.UpdateData(data, offset + 117);
        Sts_eNotifyIntlkTrip.UpdateData(data, offset + 118);
        Sts_eNotifyIOFault.UpdateData(data, offset + 119);
        Sts_eNotifyLossPos1.UpdateData(data, offset + 120);
        Sts_eNotifyLossPos2.UpdateData(data, offset + 121);
        Sts_eNotifyTransitStall.UpdateData(data, offset + 122);
        Sts_eNotifyTripFail.UpdateData(data, offset + 123);
        SrcQ.UpdateData(data, offset + 124);
        SrcQ_IO.UpdateData(data, offset + 125);
        Val_Owner.UpdateData(data, offset + 126);
        XRdy_Acq.UpdateData((data[offset + 130] & (1 << 3)) != 0);
        XRdy_Rel.UpdateData((data[offset + 130] & (1 << 4)) != 0);
        XRdy_Reset.UpdateData((data[offset + 130] & (1 << 5)) != 0);
        XRdy_ResetAckAll.UpdateData((data[offset + 130] & (1 << 6)) != 0);
