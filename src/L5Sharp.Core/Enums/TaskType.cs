...
public sealed class TaskType : LogixEnum<TaskType, string>
{
    ...
    /// <summary>
    /// Represents a Continuous <see cref="TaskType"/>, or a task configured to run continuously.
    /// </summary>
    public static readonly TaskType Continuous = new(nameof(Continuous), nameof(Continuous).ToUpper());

    /// <summary>
    /// Represents a Periodic <see cref="TaskType"/>, or a task configured to run at a specified rate.
    /// </summary>
    public static readonly TaskType Periodic = new(nameof(Periodic), nameof(Periodic).ToUpper());

    /// <summary>
    /// Represents an Event <see cref="TaskType"/>, or a task configured to run when a specified event occurs.
    /// </summary>
