...
public class Module : LogixComponent<Module>
{
    ...
    /// <summary>
    /// Gets or sets the vendor identifier for the module.
    /// The vendor identifier represents the manufacturer or provider of the module hardware.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the product code of the module, which identifies the specific product type
    /// as defined by the vendor and product type combination.
    /// </summary>
