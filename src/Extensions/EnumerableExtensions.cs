...
namespace L5Sharp.Extensions
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="IArrayType{TDataType}"/> using the enumerable collection of data type.
        /// </summary>
            ...
            where TDataType : IDataType
        {
            ...
            var dimension = list.Count <= ushort.MaxValue ? (ushort)list.Count : throw new ArgumentException();
