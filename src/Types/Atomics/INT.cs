...
{
    private short GetValue => BitConverter.ToInt16(ToBytes());
    ...
    public static implicit operator short(INT atomic) => atomic.GetValue;
    ...
    public static explicit operator BOOL(INT atomic) => new(atomic.GetValue != 0);
    ...
    public static explicit operator SINT(INT atomic) => new((sbyte)atomic.GetValue);
    ...
    public static explicit operator USINT(INT atomic) => new((byte)atomic.GetValue);
    ...
    public static explicit operator UINT(INT atomic) => new((ushort)atomic.GetValue);
    ...
    public static implicit operator DINT(INT atomic) => new(atomic.GetValue);
    ...
    public static explicit operator UDINT(INT atomic) => new((uint)atomic.GetValue);
    ...
    public static implicit operator LINT(INT atomic) => new(atomic.GetValue);
    ...
    public static explicit operator ULINT(INT atomic) => new((ulong)atomic.GetValue);
    ...
    public static implicit operator REAL(INT atomic) => new(atomic.GetValue);
