...
{
    private sbyte GetValue => (sbyte)ToBytes()[0];
    ...
    public static implicit operator sbyte(SINT atomic) => atomic.GetValue;
    ...
    public static explicit operator BOOL(SINT atomic) => new(atomic.GetValue != 0);
    ...
    public static explicit operator USINT(SINT atomic) => new((byte)atomic.GetValue);
    ...
    public static implicit operator INT(SINT atomic) => new(atomic.GetValue);
    ...
    public static explicit operator UINT(SINT atomic) => new((ushort)atomic.GetValue);
    ...
    public static implicit operator DINT(SINT atomic) => new(atomic.GetValue);
    ...
    public static explicit operator UDINT(SINT atomic) => new((uint)atomic.GetValue);
    ...
    public static implicit operator LINT(SINT atomic) => new(atomic.GetValue);
    ...
    public static explicit operator ULINT(SINT atomic) => new((ulong)atomic.GetValue);
    ...
    public static implicit operator REAL(SINT atomic) => new(atomic.GetValue);
