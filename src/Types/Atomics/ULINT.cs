...
{
    private ulong Local => BitConverter.ToUInt64(ToBytes());
    ...
    public static implicit operator ulong(ULINT atomic) => atomic.Local;
    ...
    public static explicit operator BOOL(ULINT atomic) => new(atomic.Local != 0);
    ...
    public static explicit operator SINT(ULINT atomic) => new((sbyte)atomic.Local);
    ...
    public static explicit operator USINT(ULINT atomic) => new((byte)atomic.Local);
    ...
    public static explicit operator INT(ULINT atomic) => new((short)atomic.Local);
    ...
    public static explicit operator UINT(ULINT atomic) => new((ushort)atomic.Local);
    ...
    public static explicit operator DINT(ULINT atomic) => new((int)atomic.Local);
    ...
    public static explicit operator UDINT(ULINT atomic) => new((uint)atomic.Local);
    ...
    public static explicit operator LINT(ULINT atomic) => new((long)atomic.Local);
    ...
    public static implicit operator REAL(ULINT atomic) => new(atomic.Local);
