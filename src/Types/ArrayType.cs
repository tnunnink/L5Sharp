...
public sealed class ArrayType<TLogixType> : LogixType, IEnumerable<TLogixType> where TLogixType : LogixType
{
    /// <inheritdoc />
...
/// <summary>
/// Contains method for generating default array instances specified <see cref="LogixType"/>.
/// </summary>
