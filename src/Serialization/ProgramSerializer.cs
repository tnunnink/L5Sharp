...
public class ProgramSerializer : ILogixSerializer<Program>
{
    ...
    public XElement Serialize(Program obj)
    {
        ...
        routines.Add(obj.Routines.Select(r => _routineSerializer.Serialize(r)));
    ...
    public Program Deserialize(XElement element)
    {
        ...
        return new Program
        {
            ...
            Routines = element.Descendants(L5XName.Routine).Select(e => _routineSerializer.Deserialize(e)).ToList()
        };
    }
}