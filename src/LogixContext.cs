...
namespace L5Sharp
{
    ...
    public class LogixContext : ILogixContext
    {
        ...
        /// <summary>
        /// Creates a new <see cref="LogixContext"/> instance with the provided <see cref="L5XContent"/>.
        /// </summary>
        /// <param name="l5X">The <see cref="L5XContent"/> instance that represents the loaded L5X.</param>
        private LogixContext(L5XContent l5X)
        {
            _l5X = l5X ?? throw new ArgumentNullException(nameof(l5X));
        }

        /// <summary>
        /// Creates a new <see cref="LogixContext"/> by loading the contents of the provide file name.
        /// </summary>
        /// <param name="fileName">The full path, including file name, to the L5X file to load.</param>
        /// <returns>A new <see cref="LogixContext"/> containing the contents of the specified file.</returns>
        ...
        /// </remarks>
        public static LogixContext Load(string fileName)
        {
        ...
        /// <summary>
        /// Creates a new <see cref="LogixContext"/> with the provided L5X string content.
        /// </summary>
        /// <param name="content">The string that contains the L5X content to parse.</param>
        /// <returns>A new <see cref="LogixContext"/> containing the contents of the specified string.</returns>
        /// <exception cref="ArgumentException">The string is null or empty.</exception>
        /// <remarks>
        ...
        /// </remarks>
        public static LogixContext Parse(string content)
        {
