...
namespace L5Sharp.Primitives.Tests
{
    ...
    public class UserDefinedImplementationTest : UserDefinedType
    {
        ...
        public Member MyMember01 => Members.SingleOrDefault(m => m.Name == nameof(MyMember01));
        public Member MyMember02 => Members.SingleOrDefault(m => m.Name == nameof(MyMember02));
