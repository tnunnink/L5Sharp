...
public class ComplexDataTests
{
    ...
    {
        FluentActions.Invoking(() => new ComplexData(((XElement)null!)!)).Should().Throw<ArgumentNullException>();
    }
    
    [Test]
    public void New_NullMembers_ShouldThrowArgumentNullException()
    {
        FluentActions.Invoking(() => new ComplexData("Test", null!)).Should().Throw<ArgumentNullException>();
    }
    ...
    public void New_Default_ShouldHaveExpectedValues()
    {
        ...
        type.Name.Should().Be(nameof(ComplexData));
    ...
    {
        var type = new ComplexData("Test", new List<Member>());
    ...
    {
        FluentActions.Invoking(() => new ComplexData(null!, new List<Member>())).Should().Throw<ArgumentException>();
    }

    [Test]
    public void New_NullMembers_ShouldThrowArgumentException()
    {
        FluentActions.Invoking(() => new ComplexData("Test", null!)).Should().Throw<ArgumentException>();
    }
    ...
    {
        var type = new ComplexData("MyComplex", new List<Member>
        {
            new("Member1", true),
            new("Member2", (byte)255),
            new("Member3", 1000),
    ...
    {
        var type = new ComplexData("Test", new List<Member> { new("Test", 123) });
    ...
    public void Replace_ByNameAndTypeNullMember_ShouldThrowArgumentNullException()
    {
        ...
        FluentActions.Invoking(() => type.Replace("Atomic", ((LogixData)null!)!)).Should()
    ...
    {
        var first = new ComplexData("Test", new List<Member>
        {
            new("Member1", true),
            new("Member2", (byte)255),
            new("Member3", 1000),
        ...
        var second = new ComplexData("Test", new List<Member>
        {
            new("Member1", true),
            new("Member2", (byte)255),
            new("Member3", 1000),
