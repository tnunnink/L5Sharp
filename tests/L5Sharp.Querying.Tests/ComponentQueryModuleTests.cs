...
namespace L5Sharp.Querying.Tests
{
    ...
    public class BasicModuleQueryTests
    {
        ...
        public void Contains_InvalidName_ShouldBeFalse()
        {
            ...
            var result = context.Modules().Contains(FakeName);
        ...
        public void Contains_ValidName_ShouldBeTrue()
        {
            ...
            var result = context.Modules().Contains(ValidName);
        ...
        public void Count_HasComponents_ShouldBeGreaterThanZero()
        {
            ...
            var result = context.Modules().Count();
        ...
        public void Find_HasAtLeastOnValidName_ShouldNotBeEmpty()
        {
            ...
            var results = context.Modules().Find(names);
        ...
        public void Get_NullName_ShouldThrowInvalidOperationException()
        {
            ...
            FluentActions.Invoking(() => context.Modules().Get(null!)).Should().Throw<InvalidOperationException>();
        }
        ...
        public void Get_InvalidName_ShouldThrowInvalidOperationException()
        {
            ...
            FluentActions.Invoking(() => context.Modules().Get(FakeName)).Should().Throw<InvalidOperationException>();
        }
        ...
        public void Get_ValidName_ShouldNotBeNull()
        {
            ...
            var result = context.Modules().Get(ValidName);
