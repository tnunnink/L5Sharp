...
namespace L5Sharp.Querying.Tests
{
    ...
    public class ComponentQueryInstructionTests
    {
        ...
        public void Named_NullName_ShouldThrowArgumentNullException()
        {
            ...
            FluentActions.Invoking(() => context.Instructions().Find(((ComponentName)null)!))
        ...
        public void Named_NullNameCollection_ShouldThrowArgumentNullException()
        {
            ...
            FluentActions.Invoking(() => context.Instructions().Find((ICollection<string>)((List<ComponentName>)null)!))
                .Should().Throw<ArgumentNullException>();
        }
        ...
        public void Named_ExistingNameCollection_ShouldHaveExpectedCount()
        {
            ...
            var results = context.Instructions().Find((ICollection<string>)names);
