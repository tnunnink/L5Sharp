...
public class LogixMemberTests
{
    ...
    {
        var member = new LogixMember("Test", new SINT(12));
    ...
    {
        var member = new LogixMember("Test", new INT(1234));
    ...
    {
        var member = new LogixMember("Test", new LINT(long.MaxValue));
    ...
    {
        var member = new LogixMember("Test", new USINT(12));
    ...
    {
        var member = new LogixMember("Test", new UINT(1234));
    ...
    {
        var member = new LogixMember("Test", new ULINT(long.MaxValue));
    ...
    {
        var member = new LogixMember("Test", new REAL(float.MaxValue));
    ...
    {
        var member = new LogixMember("Test", new LREAL(123.123));
    ...
    {
        var member = new LogixMember("Test", "this is a test string");
    ...
    public void SetValue_StructureAsGenericStructureType_ShouldBeExpectedValue()
    {
        ...
        member.Value = new StructureData("TIMER", new List<LogixMember> { new("PRE", 5000), new("EN", true) });
    ...
    public void SetValue_StructureWithMembersNotInType_ShouldOnlySetMembersThatAreInType()
    {
        ...
        member.Value = new Dictionary<string, LogixData>
        {
            { "Test", 123 },
            { "PRE", 5000 },
            { "Array", new DINT[] { 1, 2, 3, 4 }.ToArrayData() },
            { "EN", true }
        };
