...
namespace L5Sharp.Core.Tests.Types.Atomics
{
    ...
    public class USintTests
    {
        ...
        {
            var type = new USINT() as IConvertible;
        ...
        public void ToByte_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new USINT(value) as IConvertible;
        ...
        public void ToChar_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new USINT(_random) as IConvertible;
        ...
        public void ToSByte_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new USINT(expected) as IConvertible;
        ...
        {
            var type = new USINT(1) as IConvertible;
        ...
        public void Parse_InvalidFormat_ShouldThrowFormatException()
        {
            ...
            FluentActions.Invoking(() => USINT.Parse(fixture.Create<string>())).Should().Throw<FormatException>();
        }
        ...
        public void Equals_OverLargeCollection_ShouldWorkFairlyFast(int capacity)
        {
            ...
            var range = Enumerable.Range(0, capacity).Select(_ => new USINT(123)).ToList();

            stopwatch.Start();
            var result = range.Where(v => v == new USINT(123)).ToList();
            stopwatch.Stop();
