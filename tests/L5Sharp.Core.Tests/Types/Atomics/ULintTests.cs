...
namespace L5Sharp.Core.Tests.Types.Atomics
{
    [TestFixture]
    public class ULintTests
    {
        ...
        {
            var type = new ULINT() as IConvertible;
        ...
        public void ToByte_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new ULINT(value) as IConvertible;
        ...
        public void ToChar_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new ULINT(_random) as IConvertible;
        ...
        public void ToSByte_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new ULINT(expected) as IConvertible;
        ...
        {
            var type = new ULINT(1) as IConvertible;
        ...
        [Test]
        public void Conversion_ToULongShouldBeExpectedValue()
        {
            var type = new ULINT();
        ...
        public void Parse_InvalidFormat_ShouldThrowFormatException()
        {
            ...
            FluentActions.Invoking(() => ULINT.Parse(fixture.Create<string>())).Should().Throw<FormatException>();
        }
        ...
        public void Equals_OverLargeCollection_ShouldWorkFairlyFast(int capacity)
        {
            ...
            var range = Enumerable.Range(0, capacity).Select(_ => new ULINT(123)).ToList();

            stopwatch.Start();
            var result = range.Where(v => v == new ULINT(123)).ToList();
            stopwatch.Stop();
