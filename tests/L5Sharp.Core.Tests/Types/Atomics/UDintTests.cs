...
namespace L5Sharp.Core.Tests.Types.Atomics
{
    ...
    public class UDintTests
    {
       ...
       [Test]
        ...
        {
            var type = new UDINT() as IConvertible;
        ...
        public void ToByte_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new UDINT(value) as IConvertible;
        ...
        public void ToChar_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new UDINT(_random) as IConvertible;
        ...
        public void ToSByte_WhenCalled_ShouldBeExpectedValue()
        {
            ...
            var type = new UDINT(expected) as IConvertible;
        ...
        public void Parse_InvalidFormat_ShouldThrowFormatException()
        {
            ...
            FluentActions.Invoking(() => UDINT.Parse(fixture.Create<string>())).Should().Throw<FormatException>();
        }
        ...
        public void Equals_OverLargeCollection_ShouldWorkFairlyFast(int capacity)
        {
            ...
            var range = Enumerable.Range(0, capacity).Select(_ => new UDINT(123)).ToList();

            stopwatch.Start();
            var result = range.Where(v => v == new UDINT(123)).ToList();
            stopwatch.Stop();
