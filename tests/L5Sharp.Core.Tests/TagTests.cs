...
namespace L5Sharp.Core.Tests
{
    ...
    public class TagTests
    {
        ...
        {
            var tag = new Tag("Test", Predefined.Int, new Program("Program"));
